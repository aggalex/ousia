...
impl LockButtonBuilder {
    ...
    pub fn text_lock(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("text_lock", value);
        self
    }
    pub fn tooltip_lock(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("tooltip_lock", value);
        self
    }
    pub fn tooltip_unlock(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("tooltip_unlock", value);
        self
    }
    ...
    pub fn tooltip_not_authorized(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("tooltip_not_authorized", value);
        self
    }
    pub fn permission(&mut self, value: &impl IsA<gio::Permission>) -> &mut Self {
        self.obj.set_property("permission", value);
        self
    }
    ...
    pub fn text_unlock(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("text_unlock", value);
        self
    }
    ...
    pub fn bind(&mut self) -> LockButtonBinder {
        LockButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> LockButtonSignals {
        LockButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for LockButtonBuilder {
    type Target = LockButton;
...
impl std::ops::Deref for LockButtonBuilder {
    type Target = LockButton;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct LockButtonBinder<'builder> {
    builder: &'builder mut LockButtonBuilder,
}
impl<'builder> LockButtonBinder<'builder> {
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cursor", val));
        value.connect_update(move |value| obj.set_property("cursor", value));
        self.builder
    }
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("overflow", val));
        value.connect_update(move |value| obj.set_property("overflow", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn text_lock(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("text_lock", val));
        value.connect_update(move |value| obj.set_property("text_lock", value));
        self.builder
    }
    pub fn tooltip_lock(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_lock", val));
        value.connect_update(move |value| obj.set_property("tooltip_lock", value));
        self.builder
    }
    pub fn tooltip_unlock(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_unlock", val));
        value.connect_update(move |value| obj.set_property("tooltip_unlock", value));
        self.builder
    }
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn label(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn tooltip_not_authorized(
        &mut self,
        value: &(impl Prop<str> + ?Sized),
    ) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_not_authorized", val));
        value.connect_update(move |value| obj.set_property("tooltip_not_authorized", value));
        self.builder
    }
    pub fn permission<T: IsA<gio::Permission>>(
        &mut self,
        value: &(impl Prop<T> + ?Sized),
    ) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("permission", val));
        value.connect_update(move |value| obj.set_property("permission", value));
        self.builder
    }
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand_set", val));
        value.connect_update(move |value| obj.set_property("hexpand_set", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn text_unlock(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("text_unlock", val));
        value.connect_update(move |value| obj.set_property("text_unlock", value));
        self.builder
    }
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_top", val));
        value.connect_update(move |value| obj.set_property("margin_top", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut LockButtonBuilder {
        let obj = self.builder.obj.clone();
...
pub struct LockButtonSignals<'builder> {
    builder: &'builder mut LockButtonBuilder,
}
impl<'builder> LockButtonSignals<'builder> {}
impl ForteExt for LockButton {
    type Builder = LockButtonBuilder;
}
#[macro_export]
macro_rules ! LockButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: LockButton :: forte ()) $ ($ rest) * } } }
