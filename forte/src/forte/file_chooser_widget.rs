...
use gtkrs::{prelude::*, FileChooserWidget, *};
use gtkrs::{
...
impl FileChooserWidgetBuilder {
    ...
    pub fn search_mode(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("search_mode", value);
        self
    }
    ...
    pub fn bind(&mut self) -> FileChooserWidgetBinder {
        FileChooserWidgetBinder { builder: self }
    }
    pub fn connect(&mut self) -> FileChooserWidgetSignals {
        FileChooserWidgetSignals { builder: self }
    }
}
impl crate::prelude::Builder for FileChooserWidgetBuilder {
...
impl std::ops::Deref for FileChooserWidgetBuilder {
    type Target = FileChooserWidget;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct FileChooserWidgetBinder<'builder> {
    builder: &'builder mut FileChooserWidgetBuilder,
}
impl<'builder> FileChooserWidgetBinder<'builder> {
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FileChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut FileChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut FileChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    ) -> &mut FileChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("search_mode", val));
        value.connect_update(move |value| obj.set_property("search_mode", value));
        self.builder
    }
    pub fn focusable(
        &mut self,
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FileChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut FileChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FileChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FileChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FileChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
...
pub struct FileChooserWidgetSignals<'builder> {
    builder: &'builder mut FileChooserWidgetBuilder,
}
impl<'builder> FileChooserWidgetSignals<'builder> {}
impl ForteExt for FileChooserWidget {
    type Builder = FileChooserWidgetBuilder;
}
#[macro_export]
macro_rules ! FileChooserWidget { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: FileChooserWidget :: forte ()) $ ($ rest) * } } }
