...
impl ViewportBuilder {
    ...
    pub fn scroll_to_focus(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("scroll_to_focus", value);
        self
    }
    ...
    pub fn bind(&mut self) -> ViewportBinder {
        ViewportBinder { builder: self }
    }
    pub fn connect(&mut self) -> ViewportSignals {
        ViewportSignals { builder: self }
    }
}
impl crate::prelude::Builder for ViewportBuilder {
...
pub struct ViewportBinder<'builder> {
    builder: &'builder mut ViewportBuilder,
}
impl<'builder> ViewportBinder<'builder> {
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ViewportBuilder {
    ...
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn scroll_to_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("scroll_to_focus", val));
        value.connect_update(move |value| obj.set_property("scroll_to_focus", value));
        self.builder
    }
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("overflow", val));
        value.connect_update(move |value| obj.set_property("overflow", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_markup", val));
        value.connect_update(move |value| obj.set_property("tooltip_markup", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ViewportBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ViewportSignals<'builder> {
    builder: &'builder mut ViewportBuilder,
}
impl<'builder> ViewportSignals<'builder> {}
impl ForteExt for Viewport {
    type Builder = ViewportBuilder;
}
#[macro_export]
macro_rules ! Viewport { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: Viewport :: forte ()) $ ($ rest) * } } }
