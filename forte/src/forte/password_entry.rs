...
use gtkrs::{prelude::*, PasswordEntry, *};
use gtkrs::{
...
impl Default for PasswordEntryBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl PasswordEntryBuilder {
    ...
    pub fn show_peek_icon(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_peek_icon", value);
        self
    }
    ...
    pub fn bind(&mut self) -> PasswordEntryBinder {
        PasswordEntryBinder { builder: self }
    }
    pub fn connect(&mut self) -> PasswordEntrySignals {
        PasswordEntrySignals { builder: self }
    }
}
impl crate::prelude::Builder for PasswordEntryBuilder {
    type Target = PasswordEntry;
...
impl std::ops::Deref for PasswordEntryBuilder {
    type Target = PasswordEntry;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct PasswordEntryBinder<'builder> {
    builder: &'builder mut PasswordEntryBuilder,
}
impl<'builder> PasswordEntryBinder<'builder> {
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut PasswordEntryBuilder {
    ...
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_target", val));
        value.connect_update(move |value| obj.set_property("can_target", value));
        self.builder
    }
    pub fn show_peek_icon(
        &mut self,
        value: &(impl Prop<bool> + ?Sized),
    ) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_peek_icon", val));
        value.connect_update(move |value| obj.set_property("show_peek_icon", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn enable_undo(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("enable_undo", val));
        value.connect_update(move |value| obj.set_property("enable_undo", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand_set", val));
        value.connect_update(move |value| obj.set_property("vexpand_set", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PasswordEntryBuilder {
        let obj = self.builder.obj.clone();
...
pub struct PasswordEntrySignals<'builder> {
    builder: &'builder mut PasswordEntryBuilder,
}
impl<'builder> PasswordEntrySignals<'builder> {}
impl ForteExt for PasswordEntry {
    type Builder = PasswordEntryBuilder;
}
#[macro_export]
macro_rules ! PasswordEntry { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: PasswordEntry :: forte ()) $ ($ rest) * } } }
