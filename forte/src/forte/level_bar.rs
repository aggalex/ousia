...
impl LevelBarBuilder {
    ...
    pub fn max_value(&mut self, value: f64) -> &mut Self {
        self.obj.set_property("max_value", value);
        self
    }
    ...
    pub fn mode(&mut self, value: LevelBarMode) -> &mut Self {
    ...
    pub fn min_value(&mut self, value: f64) -> &mut Self {
        self.obj.set_property("min_value", value);
        self
    }
    ...
    pub fn bind(&mut self) -> LevelBarBinder {
        LevelBarBinder { builder: self }
    }
    pub fn connect(&mut self) -> LevelBarSignals {
        LevelBarSignals { builder: self }
    }
}
impl crate::prelude::Builder for LevelBarBuilder {
    type Target = LevelBar;
...
impl std::ops::Deref for LevelBarBuilder {
    type Target = LevelBar;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct LevelBarBinder<'builder> {
    builder: &'builder mut LevelBarBuilder,
}
impl<'builder> LevelBarBinder<'builder> {
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_top", val));
        value.connect_update(move |value| obj.set_property("margin_top", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand", val));
        value.connect_update(move |value| obj.set_property("hexpand", value));
        self.builder
    }
    pub fn value(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("value", val));
        value.connect_update(move |value| obj.set_property("value", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn max_value(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("max_value", val));
        value.connect_update(move |value| obj.set_property("max_value", value));
        self.builder
    }
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_markup", val));
        value.connect_update(move |value| obj.set_property("tooltip_markup", value));
        self.builder
    }
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cursor", val));
        value.connect_update(move |value| obj.set_property("cursor", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn min_value(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("min_value", val));
        value.connect_update(move |value| obj.set_property("min_value", value));
        self.builder
    }
    pub fn inverted(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LevelBarBuilder {
        let obj = self.builder.obj.clone();
...
pub struct LevelBarSignals<'builder> {
    builder: &'builder mut LevelBarBuilder,
}
impl<'builder> LevelBarSignals<'builder> {}
impl ForteExt for LevelBar {
    type Builder = LevelBarBuilder;
}
#[macro_export]
macro_rules ! LevelBar { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: LevelBar :: forte ()) $ ($ rest) * } } }
