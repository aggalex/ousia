...
use gtkrs::{prelude::*, VolumeButton, *};
use gtkrs::{
...
impl VolumeButtonBuilder {
    ...
    pub fn use_symbolic(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("use_symbolic", value);
        self
    }
    ...
    pub fn bind(&mut self) -> VolumeButtonBinder {
        VolumeButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> VolumeButtonSignals {
        VolumeButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for VolumeButtonBuilder {
    type Target = VolumeButton;
...
impl std::ops::Deref for VolumeButtonBuilder {
    type Target = VolumeButton;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct VolumeButtonBinder<'builder> {
    builder: &'builder mut VolumeButtonBuilder,
}
impl<'builder> VolumeButtonBinder<'builder> {
    pub fn accessible_role(
        &mut self,
        value: &(impl Prop<AccessibleRole> + ?Sized),
    ) -> &mut VolumeButtonBuilder {
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_bottom", val));
        value.connect_update(move |value| obj.set_property("margin_bottom", value));
        self.builder
    }
    pub fn use_symbolic(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("use_symbolic", val));
        value.connect_update(move |value| obj.set_property("use_symbolic", value));
        self.builder
    }
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_target", val));
        value.connect_update(move |value| obj.set_property("can_target", value));
        self.builder
    }
    pub fn width_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut VolumeButtonBuilder {
        let obj = self.builder.obj.clone();
...
pub struct VolumeButtonSignals<'builder> {
    builder: &'builder mut VolumeButtonBuilder,
}
impl<'builder> VolumeButtonSignals<'builder> {}
impl ForteExt for VolumeButton {
    type Builder = VolumeButtonBuilder;
}
#[macro_export]
macro_rules ! VolumeButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: VolumeButton :: forte ()) $ ($ rest) * } } }
