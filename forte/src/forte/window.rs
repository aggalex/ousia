...
impl WindowBuilder {
    ...
    pub fn bind(&mut self) -> WindowBinder {
        WindowBinder { builder: self }
    }
    pub fn connect(&mut self) -> WindowSignals {
        WindowSignals { builder: self }
    }
}
impl crate::prelude::Builder for WindowBuilder {
    type Target = Window;
...
pub struct WindowBinder<'builder> {
    builder: &'builder mut WindowBuilder,
}
impl<'builder> WindowBinder<'builder> {
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn title(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("title", val));
        value.connect_update(move |value| obj.set_property("title", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn resizable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("resizable", val));
        value.connect_update(move |value| obj.set_property("resizable", value));
        self.builder
    }
    pub fn default_width(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn mnemonics_visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn fullscreened(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
...
pub struct WindowSignals<'builder> {
    builder: &'builder mut WindowBuilder,
}
impl<'builder> WindowSignals<'builder> {
    pub fn modal_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_modal_notify(f);
        &mut self.builder
    }
    pub fn titlebar_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_titlebar_notify(f);
        &mut self.builder
    }
    pub fn keys_changed(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_keys_changed(f);
        &mut self.builder
    }
    pub fn maximized_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_maximized_notify(f);
        &mut self.builder
    }
    pub fn enable_debugging(&mut self, f: impl Fn(&Window, bool) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_enable_debugging(f);
        &mut self.builder
    }
    pub fn default_height_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_default_height_notify(f);
        &mut self.builder
    }
    pub fn display_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_display_notify(f);
        &mut self.builder
    }
    pub fn focus_visible_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_focus_visible_notify(f);
        &mut self.builder
    }
    pub fn hide_on_close_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_hide_on_close_notify(f);
        &mut self.builder
    }
    pub fn close_request(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_close_request(f);
        &mut self.builder
    }
    pub fn transient_for_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_transient_for_notify(f);
        &mut self.builder
    }
    pub fn icon_name_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn mnemonics_visible_notify(
        &mut self,
        f: impl Fn(&Window) + 'static,
    ) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_mnemonics_visible_notify(f);
        &mut self.builder
    }
    pub fn application_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_application_notify(f);
        &mut self.builder
    }
    pub fn child_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_child_notify(f);
        &mut self.builder
    }
    pub fn default_widget_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_default_widget_notify(f);
        &mut self.builder
    }
    pub fn fullscreened_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_fullscreened_notify(f);
        &mut self.builder
    }
    pub fn is_active_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_is_active_notify(f);
        &mut self.builder
    }
    pub fn deletable_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_deletable_notify(f);
        &mut self.builder
    }
    pub fn destroy_with_parent_notify(
        &mut self,
        f: impl Fn(&Window) + 'static,
    ) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_destroy_with_parent_notify(f);
        &mut self.builder
    }
    pub fn focus_widget_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_focus_widget_notify(f);
        &mut self.builder
    }
    pub fn activate_focus(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_activate_focus(f);
        &mut self.builder
    }
    pub fn startup_id_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_startup_id_notify(f);
        &mut self.builder
    }
    pub fn title_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_title_notify(f);
        &mut self.builder
    }
    pub fn resizable_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_resizable_notify(f);
        &mut self.builder
    }
    pub fn decorated_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_decorated_notify(f);
        &mut self.builder
    }
    pub fn default_width_notify(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_default_width_notify(f);
        &mut self.builder
    }
    pub fn handle_menubar_accel_notify(
        &mut self,
        f: impl Fn(&Window) + 'static,
    ) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_handle_menubar_accel_notify(f);
        &mut self.builder
    }
    pub fn activate_default(&mut self, f: impl Fn(&Window) + 'static) -> &mut WindowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_activate_default(f);
        &mut self.builder
    }
}
impl ForteExt for Window {
    type Builder = WindowBuilder;
}
#[macro_export]
macro_rules ! Window { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: Window :: forte ()) $ ($ rest) * } } }
