...
impl ActionBarBuilder {
    ...
    pub fn bind(&mut self) -> ActionBarBinder {
        ActionBarBinder { builder: self }
    }
    pub fn connect(&mut self) -> ActionBarSignals {
        ActionBarSignals { builder: self }
    }
}
impl crate::prelude::Builder for ActionBarBuilder {
    type Target = ActionBar;
...
impl std::ops::Deref for ActionBarBuilder {
    type Target = ActionBar;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ActionBarBinder<'builder> {
    builder: &'builder mut ActionBarBuilder,
}
impl<'builder> ActionBarBinder<'builder> {
    pub fn revealed(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ActionBarBuilder {
...
pub struct ActionBarSignals<'builder> {
    builder: &'builder mut ActionBarBuilder,
}
impl<'builder> ActionBarSignals<'builder> {}
impl ForteExt for ActionBar {
    type Builder = ActionBarBuilder;
}
#[macro_export]
macro_rules ! ActionBar { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ActionBar :: forte ()) $ ($ rest) * } } }
