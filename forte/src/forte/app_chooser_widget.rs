...
use gtkrs::{prelude::*, AppChooserWidget, *};
use gtkrs::{
...
impl AppChooserWidgetBuilder {
    pub fn show_default(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_default", value);
        self
    }
    ...
    pub fn show_fallback(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_fallback", value);
        self
    }
    ...
    pub fn content_type(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("content_type", value);
        self
    }
    ...
    pub fn show_recommended(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_recommended", value);
        self
    }
    ...
    pub fn show_other(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_other", value);
        self
    }
    ...
    pub fn show_all(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_all", value);
        self
    }
    ...
    pub fn default_text(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("default_text", value);
        self
    }
    ...
    pub fn bind(&mut self) -> AppChooserWidgetBinder {
        AppChooserWidgetBinder { builder: self }
    }
    pub fn connect(&mut self) -> AppChooserWidgetSignals {
        AppChooserWidgetSignals { builder: self }
    }
}
impl crate::prelude::Builder for AppChooserWidgetBuilder {
    type Target = AppChooserWidget;
...
impl std::ops::Deref for AppChooserWidgetBuilder {
    type Target = AppChooserWidget;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct AppChooserWidgetBinder<'builder> {
    builder: &'builder mut AppChooserWidgetBuilder,
}
impl<'builder> AppChooserWidgetBinder<'builder> {
    pub fn show_default(
        &mut self,
        value: &(impl Prop<bool> + ?Sized),
    ) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_default", val));
        value.connect_update(move |value| obj.set_property("show_default", value));
        self.builder
    }
    pub fn margin_top(
        &mut self,
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand", val));
        value.connect_update(move |value| obj.set_property("hexpand", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn show_fallback(
        ...
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_fallback", val));
        value.connect_update(move |value| obj.set_property("show_fallback", value));
        self.builder
    }
    pub fn overflow(
        &mut self,
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn content_type(
        ...
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("content_type", val));
        value.connect_update(move |value| obj.set_property("content_type", value));
        self.builder
    }
    pub fn css_classes(
        &mut self,
    ...
    pub fn show_recommended(
        &mut self,
        value: &(impl Prop<bool> + ?Sized),
    ) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_recommended", val));
        value.connect_update(move |value| obj.set_property("show_recommended", value));
        self.builder
    }
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn show_other(
        ...
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_other", val));
        value.connect_update(move |value| obj.set_property("show_other", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn show_all(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_all", val));
        value.connect_update(move |value| obj.set_property("show_all", value));
        self.builder
    }
    ...
    pub fn default_text(
        ...
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("default_text", val));
        value.connect_update(move |value| obj.set_property("default_text", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AppChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
...
pub struct AppChooserWidgetSignals<'builder> {
    builder: &'builder mut AppChooserWidgetBuilder,
}
impl<'builder> AppChooserWidgetSignals<'builder> {}
impl ForteExt for AppChooserWidget {
    type Builder = AppChooserWidgetBuilder;
}
#[macro_export]
macro_rules ! AppChooserWidget { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: AppChooserWidget :: forte ()) $ ($ rest) * } } }
