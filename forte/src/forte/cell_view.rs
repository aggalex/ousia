...
impl CellViewBuilder {
    pub fn fit_model(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("fit_model", value);
        self
    }
    ...
    pub fn cell_area_context(&mut self, value: &impl IsA<CellAreaContext>) -> &mut Self {
        self.obj.set_property("cell_area_context", value);
        self
    }
    ...
    pub fn draw_sensitive(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("draw_sensitive", value);
        self
    }
    ...
    pub fn bind(&mut self) -> CellViewBinder {
        CellViewBinder { builder: self }
    }
    pub fn connect(&mut self) -> CellViewSignals {
        CellViewSignals { builder: self }
    }
}
impl crate::prelude::Builder for CellViewBuilder {
...
impl std::ops::Deref for CellViewBuilder {
    type Target = CellView;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct CellViewBinder<'builder> {
    builder: &'builder mut CellViewBuilder,
}
impl<'builder> CellViewBinder<'builder> {
    pub fn fit_model(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("fit_model", val));
        value.connect_update(move |value| obj.set_property("fit_model", value));
        self.builder
    }
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_top", val));
        value.connect_update(move |value| obj.set_property("margin_top", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand_set", val));
        value.connect_update(move |value| obj.set_property("vexpand_set", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn cell_area_context<T: IsA<CellAreaContext>>(
        &mut self,
        value: &(impl Prop<T> + ?Sized),
    ) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cell_area_context", val));
        value.connect_update(move |value| obj.set_property("cell_area_context", value));
        self.builder
    }
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellViewBuilder {
        let obj = self.builder.obj.clone();
...
pub struct CellViewSignals<'builder> {
    builder: &'builder mut CellViewBuilder,
}
impl<'builder> CellViewSignals<'builder> {}
impl ForteExt for CellView {
    type Builder = CellViewBuilder;
}
#[macro_export]
macro_rules ! CellView { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: CellView :: forte ()) $ ($ rest) * } } }
