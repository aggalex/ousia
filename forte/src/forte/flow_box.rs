...
impl FlowBoxBuilder {
    pub fn min_children_per_line(&mut self, value: u32) -> &mut Self {
        self.obj.set_property("min_children_per_line", value);
        self
    }
    ...
    pub fn max_children_per_line(&mut self, value: u32) -> &mut Self {
        self.obj.set_property("max_children_per_line", value);
        self
    }
    ...
    pub fn column_spacing(&mut self, value: u32) -> &mut Self {
    ...
    pub fn row_spacing(&mut self, value: u32) -> &mut Self {
    ...
    pub fn accept_unpaired_release(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("accept_unpaired_release", value);
        self
    }
    ...
    pub fn bind(&mut self) -> FlowBoxBinder {
        FlowBoxBinder { builder: self }
    }
    pub fn connect(&mut self) -> FlowBoxSignals {
        FlowBoxSignals { builder: self }
    }
}
impl crate::prelude::Builder for FlowBoxBuilder {
    type Target = FlowBox;
...
impl std::ops::Deref for FlowBoxBuilder {
    type Target = FlowBox;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct FlowBoxBinder<'builder> {
    builder: &'builder mut FlowBoxBuilder,
}
impl<'builder> FlowBoxBinder<'builder> {
    pub fn min_children_per_line(
        &mut self,
        value: &(impl Prop<u32> + ?Sized),
    ) -> &mut FlowBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("min_children_per_line", val));
        value.connect_update(move |value| obj.set_property("min_children_per_line", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FlowBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn homogeneous(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FlowBoxBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FlowBoxBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FlowBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand_set", val));
        value.connect_update(move |value| obj.set_property("hexpand_set", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FlowBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FlowBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn max_children_per_line(
        &mut self,
        value: &(impl Prop<u32> + ?Sized),
    ) -> &mut FlowBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("max_children_per_line", val));
        value.connect_update(move |value| obj.set_property("max_children_per_line", value));
        self.builder
    }
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FlowBoxBuilder {
        let obj = self.builder.obj.clone();
...
pub struct FlowBoxSignals<'builder> {
    builder: &'builder mut FlowBoxBuilder,
}
impl<'builder> FlowBoxSignals<'builder> {}
impl ForteExt for FlowBox {
    type Builder = FlowBoxBuilder;
}
#[macro_export]
macro_rules ! FlowBox { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: FlowBox :: forte ()) $ ($ rest) * } } }
