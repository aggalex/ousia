...
use gtkrs::{prelude::*, FontChooserWidget, *};
use gtkrs::{
...
impl FontChooserWidgetBuilder {
    ...
    pub fn bind(&mut self) -> FontChooserWidgetBinder {
        FontChooserWidgetBinder { builder: self }
    }
    pub fn connect(&mut self) -> FontChooserWidgetSignals {
        FontChooserWidgetSignals { builder: self }
    }
}
impl crate::prelude::Builder for FontChooserWidgetBuilder {
    type Target = FontChooserWidget;
...
impl std::ops::Deref for FontChooserWidgetBuilder {
    type Target = FontChooserWidget;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct FontChooserWidgetBinder<'builder> {
    builder: &'builder mut FontChooserWidgetBuilder,
}
impl<'builder> FontChooserWidgetBinder<'builder> {
    pub fn accessible_role(
        &mut self,
        value: &(impl Prop<AccessibleRole> + ?Sized),
    ) -> &mut FontChooserWidgetBuilder {
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg_attr(feature = "v4_10", deprecated = "Since 4.10")]
    pub fn font(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("font", val));
        value.connect_update(move |value| obj.set_property("font", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg_attr(feature = "v4_10", deprecated = "Since 4.10")]
    pub fn language(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontChooserWidgetBuilder {
        let obj = self.builder.obj.clone();
...
pub struct FontChooserWidgetSignals<'builder> {
    builder: &'builder mut FontChooserWidgetBuilder,
}
impl<'builder> FontChooserWidgetSignals<'builder> {}
impl ForteExt for FontChooserWidget {
    type Builder = FontChooserWidgetBuilder;
}
#[macro_export]
macro_rules ! FontChooserWidget { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: FontChooserWidget :: forte ()) $ ($ rest) * } } }
