...
impl CheckButtonBuilder {
    ...
    pub fn group(&mut self, value: &impl IsA<CheckButton>) -> &mut Self {
    ...
    pub fn bind(&mut self) -> CheckButtonBinder {
        CheckButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> CheckButtonSignals {
        CheckButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for CheckButtonBuilder {
...
impl<'builder> CheckButtonBinder<'builder> {
    ...
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("overflow", val));
        value.connect_update(move |value| obj.set_property("overflow", value));
        self.builder
    }
    pub fn width_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
...
pub struct CheckButtonSignals<'builder> {
    builder: &'builder mut CheckButtonBuilder,
}
impl<'builder> CheckButtonSignals<'builder> {
    pub fn use_underline_notify(
        &mut self,
        f: impl Fn(&CheckButton) + 'static,
    ) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_use_underline_notify(f);
        &mut self.builder
    }
    pub fn child_notify(&mut self, f: impl Fn(&CheckButton) + 'static) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_child_notify(f);
        &mut self.builder
    }
    pub fn inconsistent_notify(
        &mut self,
        f: impl Fn(&CheckButton) + 'static,
    ) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_inconsistent_notify(f);
        &mut self.builder
    }
    pub fn toggled(&mut self, f: impl Fn(&CheckButton) + 'static) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_toggled(f);
        &mut self.builder
    }
    pub fn group_notify(&mut self, f: impl Fn(&CheckButton) + 'static) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_group_notify(f);
        &mut self.builder
    }
    pub fn active_notify(&mut self, f: impl Fn(&CheckButton) + 'static) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_active_notify(f);
        &mut self.builder
    }
    pub fn label_notify(&mut self, f: impl Fn(&CheckButton) + 'static) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_label_notify(f);
        &mut self.builder
    }
    pub fn activate(&mut self, f: impl Fn(&CheckButton) + 'static) -> &mut CheckButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_activate(f);
        &mut self.builder
    }
}
impl ForteExt for CheckButton {
    type Builder = CheckButtonBuilder;
}
#[macro_export]
macro_rules ! CheckButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: CheckButton :: forte ()) $ ($ rest) * } } }
