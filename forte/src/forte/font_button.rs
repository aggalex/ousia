...
impl FontButtonBuilder {
    ...
    pub fn use_size(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("use_size", value);
        self
    }
    ...
    pub fn use_font(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("use_font", value);
        self
    }
    ...
    pub fn bind(&mut self) -> FontButtonBinder {
        FontButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> FontButtonSignals {
        FontButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for FontButtonBuilder {
    type Target = FontButton;
...
impl std::ops::Deref for FontButtonBuilder {
    type Target = FontButton;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct FontButtonBinder<'builder> {
    builder: &'builder mut FontButtonBuilder,
}
impl<'builder> FontButtonBinder<'builder> {
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontButtonBuilder {
    ...
    ) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_classes", val));
        value.connect_update(move |value| obj.set_property("css_classes", value));
        self.builder
    }
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_bottom", val));
        value.connect_update(move |value| obj.set_property("margin_bottom", value));
        self.builder
    }
    pub fn use_size(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("use_size", val));
        value.connect_update(move |value| obj.set_property("use_size", value));
        self.builder
    }
    pub fn title(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("title", val));
        value.connect_update(move |value| obj.set_property("title", value));
        self.builder
    }
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focus_on_click", val));
        value.connect_update(move |value| obj.set_property("focus_on_click", value));
        self.builder
    }
    pub fn use_font(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("use_font", val));
        value.connect_update(move |value| obj.set_property("use_font", value));
        self.builder
    }
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cursor", val));
        value.connect_update(move |value| obj.set_property("cursor", value));
        self.builder
    }
    pub fn modal(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("modal", val));
        value.connect_update(move |value| obj.set_property("modal", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg_attr(feature = "v4_10", deprecated = "Since 4.10")]
    pub fn language(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("overflow", val));
        value.connect_update(move |value| obj.set_property("overflow", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg_attr(feature = "v4_10", deprecated = "Since 4.10")]
    pub fn font(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("font", val));
        value.connect_update(move |value| obj.set_property("font", value));
        self.builder
    }
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontButtonBuilder {
        let obj = self.builder.obj.clone();
...
pub struct FontButtonSignals<'builder> {
    builder: &'builder mut FontButtonBuilder,
}
impl<'builder> FontButtonSignals<'builder> {}
impl ForteExt for FontButton {
    type Builder = FontButtonBuilder;
}
#[macro_export]
macro_rules ! FontButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: FontButton :: forte ()) $ ($ rest) * } } }
