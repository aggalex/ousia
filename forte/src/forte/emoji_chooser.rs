...
use gtkrs::{prelude::*, EmojiChooser, *};
use gtkrs::{
...
impl Default for EmojiChooserBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl EmojiChooserBuilder {
    ...
    pub fn bind(&mut self) -> EmojiChooserBinder {
        EmojiChooserBinder { builder: self }
    }
    pub fn connect(&mut self) -> EmojiChooserSignals {
        EmojiChooserSignals { builder: self }
    }
}
impl crate::prelude::Builder for EmojiChooserBuilder {
    type Target = EmojiChooser;
...
impl std::ops::Deref for EmojiChooserBuilder {
    type Target = EmojiChooser;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct EmojiChooserBinder<'builder> {
    builder: &'builder mut EmojiChooserBuilder,
}
impl<'builder> EmojiChooserBinder<'builder> {
    pub fn has_arrow(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut EmojiChooserBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_arrow", val));
        value.connect_update(move |value| obj.set_property("has_arrow", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut EmojiChooserBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut EmojiChooserBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut EmojiChooserBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut EmojiChooserBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut EmojiChooserBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut EmojiChooserBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut EmojiChooserBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut EmojiChooserBuilder {
        let obj = self.builder.obj.clone();
...
pub struct EmojiChooserSignals<'builder> {
    builder: &'builder mut EmojiChooserBuilder,
}
impl<'builder> EmojiChooserSignals<'builder> {}
impl ForteExt for EmojiChooser {
    type Builder = EmojiChooserBuilder;
}
#[macro_export]
macro_rules ! EmojiChooser { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: EmojiChooser :: forte ()) $ ($ rest) * } } }
