...
use gtkrs::{prelude::*, ShortcutLabel, *};
use gtkrs::{
...
impl ShortcutLabelBuilder {
    ...
    pub fn disabled_text(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("disabled_text", value);
        self
    }
    ...
    pub fn bind(&mut self) -> ShortcutLabelBinder {
        ShortcutLabelBinder { builder: self }
    }
    pub fn connect(&mut self) -> ShortcutLabelSignals {
        ShortcutLabelSignals { builder: self }
    }
}
impl crate::prelude::Builder for ShortcutLabelBuilder {
    type Target = ShortcutLabel;
...
impl std::ops::Deref for ShortcutLabelBuilder {
    type Target = ShortcutLabel;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ShortcutLabelBinder<'builder> {
    builder: &'builder mut ShortcutLabelBuilder,
}
impl<'builder> ShortcutLabelBinder<'builder> {
    pub fn focus_on_click(
        &mut self,
        value: &(impl Prop<bool> + ?Sized),
    ) -> &mut ShortcutLabelBuilder {
    ...
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focusable", val));
        value.connect_update(move |value| obj.set_property("focusable", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn accelerator(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn disabled_text(
        &mut self,
        value: &(impl Prop<str> + ?Sized),
    ) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("disabled_text", val));
        value.connect_update(move |value| obj.set_property("disabled_text", value));
        self.builder
    }
    ...
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_target", val));
        value.connect_update(move |value| obj.set_property("can_target", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ShortcutLabelBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ShortcutLabelSignals<'builder> {
    builder: &'builder mut ShortcutLabelBuilder,
}
impl<'builder> ShortcutLabelSignals<'builder> {}
impl ForteExt for ShortcutLabel {
    type Builder = ShortcutLabelBuilder;
}
#[macro_export]
macro_rules ! ShortcutLabel { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ShortcutLabel :: forte ()) $ ($ rest) * } } }
