...
impl ColorButtonBuilder {
    ...
    pub fn bind(&mut self) -> ColorButtonBinder {
        ColorButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> ColorButtonSignals {
        ColorButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for ColorButtonBuilder {
    type Target = ColorButton;
...
impl std::ops::Deref for ColorButtonBuilder {
    type Target = ColorButton;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ColorButtonBinder<'builder> {
    builder: &'builder mut ColorButtonBuilder,
}
impl<'builder> ColorButtonBinder<'builder> {
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand_set", val));
        value.connect_update(move |value| obj.set_property("hexpand_set", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_markup", val));
        value.connect_update(move |value| obj.set_property("tooltip_markup", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg_attr(feature = "v4_10", deprecated = "Since 4.10")]
    pub fn use_alpha(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("use_alpha", val));
        value.connect_update(move |value| obj.set_property("use_alpha", value));
        self.builder
    }
    pub fn height_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height_request", val));
        value.connect_update(move |value| obj.set_property("height_request", value));
        self.builder
    }
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg_attr(feature = "v4_10", deprecated = "Since 4.10")]
    pub fn rgba(&mut self, value: &(impl Prop<gdk::RGBA> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn width_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("width_request", val));
        value.connect_update(move |value| obj.set_property("width_request", value));
        self.builder
    }
    pub fn modal(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorButtonBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ColorButtonSignals<'builder> {
    builder: &'builder mut ColorButtonBuilder,
}
impl<'builder> ColorButtonSignals<'builder> {}
impl ForteExt for ColorButton {
    type Builder = ColorButtonBuilder;
}
#[macro_export]
macro_rules ! ColorButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ColorButton :: forte ()) $ ($ rest) * } } }
