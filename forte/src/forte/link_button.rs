...
impl LinkButtonBuilder {
    ...
    pub fn uri(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("uri", value);
        self
    }
    ...
    pub fn visited(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("visited", value);
        self
    }
    ...
    pub fn bind(&mut self) -> LinkButtonBinder {
        LinkButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> LinkButtonSignals {
        LinkButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for LinkButtonBuilder {
...
impl std::ops::Deref for LinkButtonBuilder {
    type Target = LinkButton;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct LinkButtonBinder<'builder> {
    builder: &'builder mut LinkButtonBuilder,
}
impl<'builder> LinkButtonBinder<'builder> {
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cursor", val));
        value.connect_update(move |value| obj.set_property("cursor", value));
        self.builder
    }
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focus_on_click", val));
        value.connect_update(move |value| obj.set_property("focus_on_click", value));
        self.builder
    }
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand_set", val));
        value.connect_update(move |value| obj.set_property("vexpand_set", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand", val));
        value.connect_update(move |value| obj.set_property("hexpand", value));
        self.builder
    }
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand_set", val));
        value.connect_update(move |value| obj.set_property("hexpand_set", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn uri(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("uri", val));
        value.connect_update(move |value| obj.set_property("uri", value));
        self.builder
    }
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_target", val));
        value.connect_update(move |value| obj.set_property("can_target", value));
        self.builder
    }
    pub fn label(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("label", val));
        value.connect_update(move |value| obj.set_property("label", value));
        self.builder
    }
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_markup", val));
        value.connect_update(move |value| obj.set_property("tooltip_markup", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn height_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height_request", val));
        value.connect_update(move |value| obj.set_property("height_request", value));
        self.builder
    }
    pub fn visited(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visited", val));
        value.connect_update(move |value| obj.set_property("visited", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut LinkButtonBuilder {
        let obj = self.builder.obj.clone();
...
pub struct LinkButtonSignals<'builder> {
    builder: &'builder mut LinkButtonBuilder,
}
impl<'builder> LinkButtonSignals<'builder> {}
impl ForteExt for LinkButton {
    type Builder = LinkButtonBuilder;
}
#[macro_export]
macro_rules ! LinkButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: LinkButton :: forte ()) $ ($ rest) * } } }
