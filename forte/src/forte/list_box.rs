...
impl ListBoxBuilder {
    ...
    pub fn bind(&mut self) -> ListBoxBinder {
        ListBoxBinder { builder: self }
    }
    pub fn connect(&mut self) -> ListBoxSignals {
        ListBoxSignals { builder: self }
    }
}
impl crate::prelude::Builder for ListBoxBuilder {
    type Target = ListBox;
...
impl std::ops::Deref for ListBoxBuilder {
    type Target = ListBox;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ListBoxBinder<'builder> {
    builder: &'builder mut ListBoxBuilder,
}
impl<'builder> ListBoxBinder<'builder> {
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxBuilder {
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn show_separators(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ListBoxSignals<'builder> {
    builder: &'builder mut ListBoxBuilder,
}
impl<'builder> ListBoxSignals<'builder> {}
impl ForteExt for ListBox {
    type Builder = ListBoxBuilder;
}
#[macro_export]
macro_rules ! ListBox { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ListBox :: forte ()) $ ($ rest) * } } }
