...
use gtkrs::{prelude::*, PageSetupUnixDialog, *};
use gtkrs::{
...
pub struct PageSetupUnixDialogBuilder {
    obj: PageSetupUnixDialog,
}
impl Default for PageSetupUnixDialogBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl PageSetupUnixDialogBuilder {
    ...
    pub fn bind(&mut self) -> PageSetupUnixDialogBinder {
        PageSetupUnixDialogBinder { builder: self }
    }
    pub fn connect(&mut self) -> PageSetupUnixDialogSignals {
        PageSetupUnixDialogSignals { builder: self }
    }
}
impl crate::prelude::Builder for PageSetupUnixDialogBuilder {
    type Target = PageSetupUnixDialog;
...
impl std::ops::Deref for PageSetupUnixDialogBuilder {
    type Target = PageSetupUnixDialog;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct PageSetupUnixDialogBinder<'builder> {
    builder: &'builder mut PageSetupUnixDialogBuilder,
}
impl<'builder> PageSetupUnixDialogBinder<'builder> {
    pub fn default_widget<T: IsA<Widget>>(
        &mut self,
        value: &(impl Prop<T> + ?Sized),
    ) -> &mut PageSetupUnixDialogBuilder {
    ...
    pub fn title(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut PageSetupUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn modal(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PageSetupUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut PageSetupUnixDialogBuilder {
        let obj = self.builder.obj.clone();
...
pub struct PageSetupUnixDialogSignals<'builder> {
    builder: &'builder mut PageSetupUnixDialogBuilder,
}
impl<'builder> PageSetupUnixDialogSignals<'builder> {}
impl ForteExt for PageSetupUnixDialog {
    type Builder = PageSetupUnixDialogBuilder;
}
#[macro_export]
macro_rules ! PageSetupUnixDialog { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: PageSetupUnixDialog :: forte ()) $ ($ rest) * } } }
