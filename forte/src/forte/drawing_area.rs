...
impl DrawingAreaBuilder {
    ...
    pub fn content_width(&mut self, value: i32) -> &mut Self {
        self.obj.set_property("content_width", value);
        self
    }
    ...
    pub fn content_height(&mut self, value: i32) -> &mut Self {
        self.obj.set_property("content_height", value);
        self
    }
    ...
    pub fn bind(&mut self) -> DrawingAreaBinder {
        DrawingAreaBinder { builder: self }
    }
    pub fn connect(&mut self) -> DrawingAreaSignals {
        DrawingAreaSignals { builder: self }
    }
}
impl crate::prelude::Builder for DrawingAreaBuilder {
...
impl std::ops::Deref for DrawingAreaBuilder {
    type Target = DrawingArea;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct DrawingAreaBinder<'builder> {
    builder: &'builder mut DrawingAreaBuilder,
}
impl<'builder> DrawingAreaBinder<'builder> {
    pub fn width_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut DrawingAreaBuilder {
    ...
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn height_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height_request", val));
        value.connect_update(move |value| obj.set_property("height_request", value));
        self.builder
    }
    pub fn content_height(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("content_height", val));
        value.connect_update(move |value| obj.set_property("content_height", value));
        self.builder
    }
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand_set", val));
        value.connect_update(move |value| obj.set_property("vexpand_set", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cursor", val));
        value.connect_update(move |value| obj.set_property("cursor", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand_set", val));
        value.connect_update(move |value| obj.set_property("hexpand_set", value));
        self.builder
    }
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("overflow", val));
        value.connect_update(move |value| obj.set_property("overflow", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
...
pub struct DrawingAreaSignals<'builder> {
    builder: &'builder mut DrawingAreaBuilder,
}
impl<'builder> DrawingAreaSignals<'builder> {
    pub fn resize(
        &mut self,
        f: impl Fn(&DrawingArea, i32, i32) + 'static,
    ) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_resize(f);
        &mut self.builder
    }
    pub fn content_width_notify(
        &mut self,
        f: impl Fn(&DrawingArea) + 'static,
    ) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_content_width_notify(f);
        &mut self.builder
    }
    pub fn content_height_notify(
        &mut self,
        f: impl Fn(&DrawingArea) + 'static,
    ) -> &mut DrawingAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_content_height_notify(f);
        &mut self.builder
    }
}
impl ForteExt for DrawingArea {
    type Builder = DrawingAreaBuilder;
}
#[macro_export]
macro_rules ! DrawingArea { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: DrawingArea :: forte ()) $ ($ rest) * } } }
