...
use crate::prelude::*;
use gtkrs::glib::prelude::*;
use gtkrs::{prelude::*, FileChooserDialog, *};
use gtkrs::{
...
impl FileChooserDialogBuilder {
    ...
    pub fn bind(&mut self) -> FileChooserDialogBinder {
        FileChooserDialogBinder { builder: self }
    }
    pub fn connect(&mut self) -> FileChooserDialogSignals {
        FileChooserDialogSignals { builder: self }
    }
}
impl crate::prelude::Builder for FileChooserDialogBuilder {
    type Target = FileChooserDialog;
...
impl std::ops::Deref for FileChooserDialogBuilder {
    type Target = FileChooserDialog;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct FileChooserDialogBinder<'builder> {
    builder: &'builder mut FileChooserDialogBuilder,
}
impl<'builder> FileChooserDialogBinder<'builder> {
    pub fn tooltip_markup(
        &mut self,
        value: &(impl Prop<str> + ?Sized),
    ) -> &mut FileChooserDialogBuilder {
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn modal(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn title(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand", val));
        value.connect_update(move |value| obj.set_property("hexpand", value));
        self.builder
    }
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FileChooserDialogBuilder {
        let obj = self.builder.obj.clone();
...
pub struct FileChooserDialogSignals<'builder> {
    builder: &'builder mut FileChooserDialogBuilder,
}
impl<'builder> FileChooserDialogSignals<'builder> {}
impl ForteExt for FileChooserDialog {
    type Builder = FileChooserDialogBuilder;
}
#[macro_export]
macro_rules ! FileChooserDialog { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: FileChooserDialog :: forte ()) $ ($ rest) * } } }
