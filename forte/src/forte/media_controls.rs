...
use gtkrs::{prelude::*, MediaControls, *};
use gtkrs::{
...
impl Default for MediaControlsBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl MediaControlsBuilder {
    ...
    pub fn bind(&mut self) -> MediaControlsBinder {
        MediaControlsBinder { builder: self }
    }
    pub fn connect(&mut self) -> MediaControlsSignals {
        MediaControlsSignals { builder: self }
    }
}
impl crate::prelude::Builder for MediaControlsBuilder {
    type Target = MediaControls;
...
impl std::ops::Deref for MediaControlsBuilder {
    type Target = MediaControls;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct MediaControlsBinder<'builder> {
    builder: &'builder mut MediaControlsBuilder,
}
impl<'builder> MediaControlsBinder<'builder> {
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focusable", val));
        value.connect_update(move |value| obj.set_property("focusable", value));
        self.builder
    }
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand", val));
        value.connect_update(move |value| obj.set_property("hexpand", value));
        self.builder
    }
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_top", val));
        value.connect_update(move |value| obj.set_property("margin_top", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut MediaControlsBuilder {
        let obj = self.builder.obj.clone();
...
pub struct MediaControlsSignals<'builder> {
    builder: &'builder mut MediaControlsBuilder,
}
impl<'builder> MediaControlsSignals<'builder> {}
impl ForteExt for MediaControls {
    type Builder = MediaControlsBuilder;
}
#[macro_export]
macro_rules ! MediaControls { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: MediaControls :: forte ()) $ ($ rest) * } } }
