...
impl Default for ColumnViewBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl ColumnViewBuilder {
    ...
    pub fn show_column_separators(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_column_separators", value);
        self
    }
    ...
    pub fn show_row_separators(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_row_separators", value);
        self
    }
    ...
    pub fn bind(&mut self) -> ColumnViewBinder {
        ColumnViewBinder { builder: self }
    }
    pub fn connect(&mut self) -> ColumnViewSignals {
        ColumnViewSignals { builder: self }
    }
}
impl crate::prelude::Builder for ColumnViewBuilder {
    type Target = ColumnView;
...
impl std::ops::Deref for ColumnViewBuilder {
    type Target = ColumnView;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ColumnViewBinder<'builder> {
    builder: &'builder mut ColumnViewBuilder,
}
impl<'builder> ColumnViewBinder<'builder> {
    pub fn vscroll_policy(
        &mut self,
        value: &(impl Prop<ScrollablePolicy> + ?Sized),
    ) -> &mut ColumnViewBuilder {
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focus_on_click", val));
        value.connect_update(move |value| obj.set_property("focus_on_click", value));
        self.builder
    }
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_bottom", val));
        value.connect_update(move |value| obj.set_property("margin_bottom", value));
        self.builder
    }
    pub fn show_row_separators(
        &mut self,
        value: &(impl Prop<bool> + ?Sized),
    ) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_row_separators", val));
        value.connect_update(move |value| obj.set_property("show_row_separators", value));
        self.builder
    }
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_markup", val));
        value.connect_update(move |value| obj.set_property("tooltip_markup", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_top", val));
        value.connect_update(move |value| obj.set_property("margin_top", value));
        self.builder
    }
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ColumnViewBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ColumnViewSignals<'builder> {
    builder: &'builder mut ColumnViewBuilder,
}
impl<'builder> ColumnViewSignals<'builder> {}
impl ForteExt for ColumnView {
    type Builder = ColumnViewBuilder;
}
#[macro_export]
macro_rules ! ColumnView { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ColumnView :: forte ()) $ ($ rest) * } } }
