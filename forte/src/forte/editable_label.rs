...
use gtkrs::{prelude::*, EditableLabel, *};
use gtkrs::{
...
impl Default for EditableLabelBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl EditableLabelBuilder {
    ...
    pub fn editing(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("editing", value);
        self
    }
    ...
    pub fn bind(&mut self) -> EditableLabelBinder {
        EditableLabelBinder { builder: self }
    }
    pub fn connect(&mut self) -> EditableLabelSignals {
        EditableLabelSignals { builder: self }
    }
}
impl crate::prelude::Builder for EditableLabelBuilder {
    type Target = EditableLabel;
...
impl std::ops::Deref for EditableLabelBuilder {
    type Target = EditableLabel;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct EditableLabelBinder<'builder> {
    builder: &'builder mut EditableLabelBuilder,
}
impl<'builder> EditableLabelBinder<'builder> {
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut EditableLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut EditableLabelBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg(any(feature = "v4_8", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v4_8")))]
    pub fn editing(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut EditableLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("editing", val));
        value.connect_update(move |value| obj.set_property("editing", value));
        self.builder
    }
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut EditableLabelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut EditableLabelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut EditableLabelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_top", val));
        value.connect_update(move |value| obj.set_property("margin_top", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut EditableLabelBuilder {
        let obj = self.builder.obj.clone();
...
pub struct EditableLabelSignals<'builder> {
    builder: &'builder mut EditableLabelBuilder,
}
impl<'builder> EditableLabelSignals<'builder> {}
impl ForteExt for EditableLabel {
    type Builder = EditableLabelBuilder;
}
#[macro_export]
macro_rules ! EditableLabel { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: EditableLabel :: forte ()) $ ($ rest) * } } }
