...
use gtkrs::{prelude::*, StackSidebar, *};
use gtkrs::{
...
impl StackSidebarBuilder {
    ...
    pub fn stack(&mut self, value: &Stack) -> &mut Self {
        self.obj.set_property("stack", value);
        self
    }
    ...
    pub fn bind(&mut self) -> StackSidebarBinder {
        StackSidebarBinder { builder: self }
    }
    pub fn connect(&mut self) -> StackSidebarSignals {
        StackSidebarSignals { builder: self }
    }
}
impl crate::prelude::Builder for StackSidebarBuilder {
    type Target = StackSidebar;
...
impl std::ops::Deref for StackSidebarBuilder {
    type Target = StackSidebar;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct StackSidebarBinder<'builder> {
    builder: &'builder mut StackSidebarBuilder,
}
impl<'builder> StackSidebarBinder<'builder> {
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand_set", val));
        value.connect_update(move |value| obj.set_property("vexpand_set", value));
        self.builder
    }
    pub fn stack(&mut self, value: &(impl Prop<Stack> + ?Sized)) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("stack", val));
        value.connect_update(move |value| obj.set_property("stack", value));
        self.builder
    }
    pub fn height_request(
        &mut self,
        value: &(impl Prop<i32> + ?Sized),
    ) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut StackSidebarBuilder {
        let obj = self.builder.obj.clone();
...
pub struct StackSidebarSignals<'builder> {
    builder: &'builder mut StackSidebarBuilder,
}
impl<'builder> StackSidebarSignals<'builder> {}
impl ForteExt for StackSidebar {
    type Builder = StackSidebarBuilder;
}
#[macro_export]
macro_rules ! StackSidebar { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: StackSidebar :: forte ()) $ ($ rest) * } } }
