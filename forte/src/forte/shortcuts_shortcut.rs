...
use gtkrs::{prelude::*, ShortcutsShortcut, *};
use gtkrs::{
...
impl ShortcutsShortcutBuilder {
    pub fn title_size_group(&mut self, value: &SizeGroup) -> &mut Self {
        self.obj.set_property("title_size_group", value);
        self
    }
    ...
    pub fn icon(&mut self, value: &impl IsA<gio::Icon>) -> &mut Self {
        self.obj.set_property("icon", value);
        self
    }
    ...
    pub fn accel_size_group(&mut self, value: &SizeGroup) -> &mut Self {
        self.obj.set_property("accel_size_group", value);
        self
    }
    ...
    pub fn subtitle_set(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("subtitle_set", value);
        self
    }
    ...
    pub fn accelerator(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("accelerator", value);
        self
    }
    ...
    pub fn subtitle(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("subtitle", value);
        self
    }
    ...
    pub fn icon_set(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("icon_set", value);
        self
    }
    pub fn shortcut_type(&mut self, value: ShortcutType) -> &mut Self {
        self.obj.set_property("shortcut_type", value);
        self
    }
    ...
    pub fn bind(&mut self) -> ShortcutsShortcutBinder {
        ShortcutsShortcutBinder { builder: self }
    }
    pub fn connect(&mut self) -> ShortcutsShortcutSignals {
        ShortcutsShortcutSignals { builder: self }
    }
}
impl crate::prelude::Builder for ShortcutsShortcutBuilder {
    type Target = ShortcutsShortcut;
...
impl std::ops::Deref for ShortcutsShortcutBuilder {
    type Target = ShortcutsShortcut;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ShortcutsShortcutBinder<'builder> {
    builder: &'builder mut ShortcutsShortcutBuilder,
}
impl<'builder> ShortcutsShortcutBinder<'builder> {
    pub fn title_size_group(
        &mut self,
        value: &(impl Prop<SizeGroup> + ?Sized),
    ) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("title_size_group", val));
        value.connect_update(move |value| obj.set_property("title_size_group", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn icon<T: IsA<gio::Icon>>(
        &mut self,
        value: &(impl Prop<T> + ?Sized),
    ) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("icon", val));
        value.connect_update(move |value| obj.set_property("icon", value));
        self.builder
    }
    ...
    pub fn title(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn accel_size_group(
        &mut self,
        value: &(impl Prop<SizeGroup> + ?Sized),
    ) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("accel_size_group", val));
        value.connect_update(move |value| obj.set_property("accel_size_group", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn subtitle_set(
        ...
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("subtitle_set", val));
        value.connect_update(move |value| obj.set_property("subtitle_set", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn accelerator(
        ...
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("accelerator", val));
        value.connect_update(move |value| obj.set_property("accelerator", value));
        self.builder
    }
    pub fn css_classes(
        &mut self,
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn subtitle(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("subtitle", val));
        value.connect_update(move |value| obj.set_property("subtitle", value));
        self.builder
    }
    ...
    pub fn icon_set(
        ...
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("icon_set", val));
        value.connect_update(move |value| obj.set_property("icon_set", value));
        self.builder
    }
    pub fn shortcut_type(
        &mut self,
        value: &(impl Prop<ShortcutType> + ?Sized),
    ) -> &mut ShortcutsShortcutBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("shortcut_type", val));
        value.connect_update(move |value| obj.set_property("shortcut_type", value));
        self.builder
    }
    pub fn vexpand_set(
        &mut self,
...
pub struct ShortcutsShortcutSignals<'builder> {
    builder: &'builder mut ShortcutsShortcutBuilder,
}
impl<'builder> ShortcutsShortcutSignals<'builder> {}
impl ForteExt for ShortcutsShortcut {
    type Builder = ShortcutsShortcutBuilder;
}
#[macro_export]
macro_rules ! ShortcutsShortcut { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ShortcutsShortcut :: forte ()) $ ($ rest) * } } }
