...
use gtkrs::{prelude::*, CellRendererText, *};
...
impl CellRendererTextBuilder {
    ...
    pub fn bind(&mut self) -> CellRendererTextBinder {
        CellRendererTextBinder { builder: self }
    }
    pub fn connect(&mut self) -> CellRendererTextSignals {
        CellRendererTextSignals { builder: self }
    }
}
impl crate::prelude::Builder for CellRendererTextBuilder {
    type Target = CellRendererText;
...
impl std::ops::Deref for CellRendererTextBuilder {
    type Target = CellRendererText;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct CellRendererTextBinder<'builder> {
    builder: &'builder mut CellRendererTextBuilder,
}
impl<'builder> CellRendererTextBinder<'builder> {
    pub fn weight(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("weight", val));
        value.connect_update(move |value| obj.set_property("weight", value));
        self.builder
    }
    pub fn scale(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("markup", val));
        value.connect_update(move |value| obj.set_property("markup", value));
        self.builder
    }
    pub fn family(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("family", val));
        value.connect_update(move |value| obj.set_property("family", value));
        self.builder
    }
    pub fn xalign(&mut self, value: &(impl Prop<f32> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn rise_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn height(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn yalign(&mut self, value: &(impl Prop<f32> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn size_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn ypad(&mut self, value: &(impl Prop<u32> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("ypad", val));
        value.connect_update(move |value| obj.set_property("ypad", value));
        self.builder
    }
    pub fn size(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn xpad(&mut self, value: &(impl Prop<u32> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn language(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("language", val));
        value.connect_update(move |value| obj.set_property("language", value));
        self.builder
    }
    pub fn font(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn rise(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn width(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn editable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
...
pub struct CellRendererTextSignals<'builder> {
    builder: &'builder mut CellRendererTextBuilder,
}
impl<'builder> CellRendererTextSignals<'builder> {
    pub fn language_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn wrap_width_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_wrap_width_notify(f);
        &mut self.builder
    }
    pub fn size_notify(
        &mut self,
    ...
    pub fn align_set_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_align_set_notify(f);
        &mut self.builder
    }
    pub fn placeholder_text_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn ellipsize_set_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_ellipsize_set_notify(f);
        &mut self.builder
    }
    pub fn font_notify(
        &mut self,
    ...
    pub fn max_width_chars_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_max_width_chars_notify(f);
        &mut self.builder
    }
    pub fn rise_notify(
        &mut self,
    ...
    pub fn alignment_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_alignment_notify(f);
        &mut self.builder
    }
    pub fn width_chars_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_width_chars_notify(f);
        &mut self.builder
    }
    pub fn editable_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn edited(
        &mut self,
        f: impl Fn(&CellRendererText, TreePath, &str) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_edited(f);
        &mut self.builder
    }
    pub fn attributes_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn ellipsize_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_ellipsize_notify(f);
        &mut self.builder
    }
    pub fn underline_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn markup_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_markup_notify(f);
        &mut self.builder
    }
    pub fn underline_set_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn single_paragraph_mode_notify(
        &mut self,
        f: impl Fn(&CellRendererText) + 'static,
    ) -> &mut CellRendererTextBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_single_paragraph_mode_notify(f);
        &mut self.builder
    }
}
impl ForteExt for CellRendererText {
    type Builder = CellRendererTextBuilder;
}
#[macro_export]
macro_rules ! CellRendererText { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: CellRendererText :: forte ()) $ ($ rest) * } } }
