...
use gtkrs::{prelude::*, ShortcutsGroup, *};
use gtkrs::{
...
impl ShortcutsGroupBuilder {
    ...
    pub fn view(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("view", value);
        self
    }
    ...
    pub fn bind(&mut self) -> ShortcutsGroupBinder {
        ShortcutsGroupBinder { builder: self }
    }
    pub fn connect(&mut self) -> ShortcutsGroupSignals {
        ShortcutsGroupSignals { builder: self }
    }
}
impl crate::prelude::Builder for ShortcutsGroupBuilder {
    type Target = ShortcutsGroup;
...
impl std::ops::Deref for ShortcutsGroupBuilder {
    type Target = ShortcutsGroup;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ShortcutsGroupBinder<'builder> {
    builder: &'builder mut ShortcutsGroupBuilder,
}
impl<'builder> ShortcutsGroupBinder<'builder> {
    pub fn title_size_group(
        &mut self,
        value: &(impl Prop<SizeGroup> + ?Sized),
    ) -> &mut ShortcutsGroupBuilder {
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn title(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("title", val));
        value.connect_update(move |value| obj.set_property("title", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focusable", val));
        value.connect_update(move |value| obj.set_property("focusable", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn spacing(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("spacing", val));
        value.connect_update(move |value| obj.set_property("spacing", value));
        self.builder
    }
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn view(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("view", val));
        value.connect_update(move |value| obj.set_property("view", value));
        self.builder
    }
    pub fn hexpand_set(
        &mut self,
    ...
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsGroupBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ShortcutsGroupSignals<'builder> {
    builder: &'builder mut ShortcutsGroupBuilder,
}
impl<'builder> ShortcutsGroupSignals<'builder> {}
impl ForteExt for ShortcutsGroup {
    type Builder = ShortcutsGroupBuilder;
}
#[macro_export]
macro_rules ! ShortcutsGroup { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ShortcutsGroup :: forte ()) $ ($ rest) * } } }
