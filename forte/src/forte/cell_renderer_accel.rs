...
use gtkrs::{prelude::*, CellRendererAccel, *};
use gtkrs::{CellRenderer, CellRendererAccelMode, CellRendererMode, CellRendererText, TreePath};
#[derive(Clone)]
...
impl CellRendererAccelBuilder {
    ...
    pub fn keycode(&mut self, value: u32) -> &mut Self {
        self.obj.set_property("keycode", value);
        self
    }
    ...
    pub fn accel_key(&mut self, value: u32) -> &mut Self {
        self.obj.set_property("accel_key", value);
        self
    }
    ...
    pub fn accel_mods(&mut self, value: gdk::ModifierType) -> &mut Self {
        self.obj.set_property("accel_mods", value);
        self
    }
    ...
    pub fn accel_mode(&mut self, value: CellRendererAccelMode) -> &mut Self {
        self.obj.set_property("accel_mode", value);
        self
    }
    ...
    pub fn bind(&mut self) -> CellRendererAccelBinder {
        CellRendererAccelBinder { builder: self }
    }
    pub fn connect(&mut self) -> CellRendererAccelSignals {
        CellRendererAccelSignals { builder: self }
    }
}
impl crate::prelude::Builder for CellRendererAccelBuilder {
    type Target = CellRendererAccel;
...
impl std::ops::Deref for CellRendererAccelBuilder {
    type Target = CellRendererAccel;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct CellRendererAccelBinder<'builder> {
    builder: &'builder mut CellRendererAccelBuilder,
}
impl<'builder> CellRendererAccelBinder<'builder> {
    pub fn width(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererAccelBuilder {
    ...
    pub fn family(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("family", val));
        value.connect_update(move |value| obj.set_property("family", value));
        self.builder
    }
    pub fn language(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn size(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn keycode(&mut self, value: &(impl Prop<u32> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("keycode", val));
        value.connect_update(move |value| obj.set_property("keycode", value));
        self.builder
    }
    pub fn attributes(
        &mut self,
    ...
    pub fn accel_key(
        ...
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("accel_key", val));
        value.connect_update(move |value| obj.set_property("accel_key", value));
        self.builder
    }
    pub fn xalign(&mut self, value: &(impl Prop<f32> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn rise(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn font(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn yalign(&mut self, value: &(impl Prop<f32> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn accel_mods(
        &mut self,
        value: &(impl Prop<gdk::ModifierType> + ?Sized),
    ) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("accel_mods", val));
        value.connect_update(move |value| obj.set_property("accel_mods", value));
        self.builder
    }
    pub fn height(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn accel_mode(
        &mut self,
        value: &(impl Prop<CellRendererAccelMode> + ?Sized),
    ) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("accel_mode", val));
        value.connect_update(move |value| obj.set_property("accel_mode", value));
        self.builder
    }
    pub fn xpad(&mut self, value: &(impl Prop<u32> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn weight(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn scale(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("scale", val));
        value.connect_update(move |value| obj.set_property("scale", value));
        self.builder
    }
    pub fn ypad(&mut self, value: &(impl Prop<u32> + ?Sized)) -> &mut CellRendererAccelBuilder {
        let obj = self.builder.obj.clone();
...
pub struct CellRendererAccelSignals<'builder> {
    builder: &'builder mut CellRendererAccelBuilder,
}
impl<'builder> CellRendererAccelSignals<'builder> {}
impl ForteExt for CellRendererAccel {
    type Builder = CellRendererAccelBuilder;
}
#[macro_export]
macro_rules ! CellRendererAccel { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: CellRendererAccel :: forte ()) $ ($ rest) * } } }
