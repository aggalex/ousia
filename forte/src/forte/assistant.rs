...
impl AssistantBuilder {
    ...
    pub fn bind(&mut self) -> AssistantBinder {
        AssistantBinder { builder: self }
    }
    pub fn connect(&mut self) -> AssistantSignals {
        AssistantSignals { builder: self }
    }
}
impl crate::prelude::Builder for AssistantBuilder {
    type Target = Assistant;
...
impl std::ops::Deref for AssistantBuilder {
    type Target = Assistant;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct AssistantBinder<'builder> {
    builder: &'builder mut AssistantBuilder,
}
impl<'builder> AssistantBinder<'builder> {
    pub fn width_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut AssistantBuilder {
    ...
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut AssistantBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut AssistantBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut AssistantBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AssistantBuilder {
        let obj = self.builder.obj.clone();
...
pub struct AssistantSignals<'builder> {
    builder: &'builder mut AssistantBuilder,
}
impl<'builder> AssistantSignals<'builder> {}
impl ForteExt for Assistant {
    type Builder = AssistantBuilder;
}
#[macro_export]
macro_rules ! Assistant { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: Assistant :: forte ()) $ ($ rest) * } } }
