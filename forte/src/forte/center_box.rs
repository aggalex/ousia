...
impl Default for CenterBoxBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl CenterBoxBuilder {
    ...
    pub fn start_widget(&mut self, value: &impl IsA<Widget>) -> &mut Self {
        self.obj.set_property("start_widget", value);
        self
    }
    ...
    #[cfg(any(feature = "v4_10", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v4_10")))]
    pub fn center_widget(&mut self, value: &impl IsA<Widget>) -> &mut Self {
        self.obj.set_property("center_widget", value);
        self
    }
    ...
    #[cfg(any(feature = "v4_10", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v4_10")))]
    pub fn end_widget(&mut self, value: &impl IsA<Widget>) -> &mut Self {
        self.obj.set_property("end_widget", value);
        self
    }
    ...
    pub fn bind(&mut self) -> CenterBoxBinder {
        CenterBoxBinder { builder: self }
    }
    pub fn connect(&mut self) -> CenterBoxSignals {
        CenterBoxSignals { builder: self }
    }
}
impl crate::prelude::Builder for CenterBoxBuilder {
    type Target = CenterBox;
...
impl std::ops::Deref for CenterBoxBuilder {
    type Target = CenterBox;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct CenterBoxBinder<'builder> {
    builder: &'builder mut CenterBoxBuilder,
}
impl<'builder> CenterBoxBinder<'builder> {
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CenterBoxBuilder {
    ...
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg(any(feature = "v4_10", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v4_10")))]
    pub fn start_widget<T: IsA<Widget>>(
        &mut self,
        value: &(impl Prop<T> + ?Sized),
    ) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("start_widget", val));
        value.connect_update(move |value| obj.set_property("start_widget", value));
        self.builder
    }
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cursor", val));
        value.connect_update(move |value| obj.set_property("cursor", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_markup", val));
        value.connect_update(move |value| obj.set_property("tooltip_markup", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focusable", val));
        value.connect_update(move |value| obj.set_property("focusable", value));
        self.builder
    }
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand", val));
        value.connect_update(move |value| obj.set_property("hexpand", value));
        self.builder
    }
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_bottom", val));
        value.connect_update(move |value| obj.set_property("margin_bottom", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg(any(feature = "v4_10", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v4_10")))]
    pub fn center_widget<T: IsA<Widget>>(
        &mut self,
        value: &(impl Prop<T> + ?Sized),
    ) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("center_widget", val));
        value.connect_update(move |value| obj.set_property("center_widget", value));
        self.builder
    }
    pub fn height_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height_request", val));
        value.connect_update(move |value| obj.set_property("height_request", value));
        self.builder
    }
    pub fn width_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("width_request", val));
        value.connect_update(move |value| obj.set_property("width_request", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focus_on_click", val));
        value.connect_update(move |value| obj.set_property("focus_on_click", value));
        self.builder
    }
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
    ...
    #[cfg(any(feature = "v4_10", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v4_10")))]
    pub fn end_widget<T: IsA<Widget>>(
        &mut self,
        value: &(impl Prop<T> + ?Sized),
    ) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("end_widget", val));
        value.connect_update(move |value| obj.set_property("end_widget", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CenterBoxBuilder {
        let obj = self.builder.obj.clone();
...
pub struct CenterBoxSignals<'builder> {
    builder: &'builder mut CenterBoxBuilder,
}
impl<'builder> CenterBoxSignals<'builder> {}
impl ForteExt for CenterBox {
    type Builder = CenterBoxBuilder;
}
#[macro_export]
macro_rules ! CenterBox { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: CenterBox :: forte ()) $ ($ rest) * } } }
