...
impl RevealerBuilder {
    ...
    pub fn reveal_child(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("reveal_child", value);
        self
    }
    ...
    pub fn transition_type(&mut self, value: RevealerTransitionType) -> &mut Self {
    ...
    pub fn bind(&mut self) -> RevealerBinder {
        RevealerBinder { builder: self }
    }
    pub fn connect(&mut self) -> RevealerSignals {
        RevealerSignals { builder: self }
    }
}
impl crate::prelude::Builder for RevealerBuilder {
    type Target = Revealer;
...
impl std::ops::Deref for RevealerBuilder {
    type Target = Revealer;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct RevealerBinder<'builder> {
    builder: &'builder mut RevealerBuilder,
}
impl<'builder> RevealerBinder<'builder> {
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut RevealerBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand", val));
        value.connect_update(move |value| obj.set_property("hexpand", value));
        self.builder
    }
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut RevealerBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut RevealerBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn transition_type(
        &mut self,
        value: &(impl Prop<RevealerTransitionType> + ?Sized),
    ) -> &mut RevealerBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut RevealerBuilder {
        let obj = self.builder.obj.clone();
...
pub struct RevealerSignals<'builder> {
    builder: &'builder mut RevealerBuilder,
}
impl<'builder> RevealerSignals<'builder> {}
impl ForteExt for Revealer {
    type Builder = RevealerBuilder;
}
#[macro_export]
macro_rules ! Revealer { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: Revealer :: forte ()) $ ($ rest) * } } }
