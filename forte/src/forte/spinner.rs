...
impl SpinnerBuilder {
    ...
    pub fn spinning(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("spinning", value);
        self
    }
    ...
    pub fn bind(&mut self) -> SpinnerBinder {
        SpinnerBinder { builder: self }
    }
    pub fn connect(&mut self) -> SpinnerSignals {
        SpinnerSignals { builder: self }
    }
}
impl crate::prelude::Builder for SpinnerBuilder {
    type Target = Spinner;
...
impl std::ops::Deref for SpinnerBuilder {
    type Target = Spinner;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct SpinnerBinder<'builder> {
    builder: &'builder mut SpinnerBuilder,
}
impl<'builder> SpinnerBinder<'builder> {
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut SpinnerBuilder {
    ...
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SpinnerBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut SpinnerBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn spinning(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SpinnerBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("spinning", val));
        value.connect_update(move |value| obj.set_property("spinning", value));
        self.builder
    }
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SpinnerBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SpinnerBuilder {
        let obj = self.builder.obj.clone();
...
pub struct SpinnerSignals<'builder> {
    builder: &'builder mut SpinnerBuilder,
}
impl<'builder> SpinnerSignals<'builder> {}
impl ForteExt for Spinner {
    type Builder = SpinnerBuilder;
}
#[macro_export]
macro_rules ! Spinner { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: Spinner :: forte ()) $ ($ rest) * } } }
