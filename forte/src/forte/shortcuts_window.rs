...
use gtkrs::{prelude::*, ShortcutsWindow, *};
use gtkrs::{
...
impl ShortcutsWindowBuilder {
    ...
    pub fn bind(&mut self) -> ShortcutsWindowBinder {
        ShortcutsWindowBinder { builder: self }
    }
    pub fn connect(&mut self) -> ShortcutsWindowSignals {
        ShortcutsWindowSignals { builder: self }
    }
}
impl crate::prelude::Builder for ShortcutsWindowBuilder {
    type Target = ShortcutsWindow;
...
impl std::ops::Deref for ShortcutsWindowBuilder {
    type Target = ShortcutsWindow;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ShortcutsWindowBinder<'builder> {
    builder: &'builder mut ShortcutsWindowBuilder,
}
impl<'builder> ShortcutsWindowBinder<'builder> {
    pub fn modal(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("modal", val));
        value.connect_update(move |value| obj.set_property("modal", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn decorated(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_top", val));
        value.connect_update(move |value| obj.set_property("margin_top", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn deletable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn startup_id(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn resizable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("resizable", val));
        value.connect_update(move |value| obj.set_property("resizable", value));
        self.builder
    }
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn icon_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("icon_name", val));
        value.connect_update(move |value| obj.set_property("icon_name", value));
        self.builder
    }
    pub fn title(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn maximized(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn view_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ShortcutsWindowBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ShortcutsWindowSignals<'builder> {
    builder: &'builder mut ShortcutsWindowBuilder,
}
impl<'builder> ShortcutsWindowSignals<'builder> {}
impl ForteExt for ShortcutsWindow {
    type Builder = ShortcutsWindowBuilder;
}
#[macro_export]
macro_rules ! ShortcutsWindow { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ShortcutsWindow :: forte ()) $ ($ rest) * } } }
