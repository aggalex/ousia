...
impl ExpanderBuilder {
    ...
    pub fn resize_toplevel(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("resize_toplevel", value);
        self
    }
    ...
    pub fn label_widget(&mut self, value: &impl IsA<Widget>) -> &mut Self {
        self.obj.set_property("label_widget", value);
        self
    }
    ...
    pub fn expanded(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("expanded", value);
        self
    }
    ...
    pub fn bind(&mut self) -> ExpanderBinder {
        ExpanderBinder { builder: self }
    }
    pub fn connect(&mut self) -> ExpanderSignals {
        ExpanderSignals { builder: self }
    }
}
impl crate::prelude::Builder for ExpanderBuilder {
...
impl std::ops::Deref for ExpanderBuilder {
    type Target = Expander;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ExpanderBinder<'builder> {
    builder: &'builder mut ExpanderBuilder,
}
impl<'builder> ExpanderBinder<'builder> {
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
    ...
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn use_markup(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("use_markup", val));
        value.connect_update(move |value| obj.set_property("use_markup", value));
        self.builder
    }
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("overflow", val));
        value.connect_update(move |value| obj.set_property("overflow", value));
        self.builder
    }
    pub fn resize_toplevel(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("resize_toplevel", val));
        value.connect_update(move |value| obj.set_property("resize_toplevel", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn width_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("width_request", val));
        value.connect_update(move |value| obj.set_property("width_request", value));
        self.builder
    }
    pub fn label(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("label", val));
        value.connect_update(move |value| obj.set_property("label", value));
        self.builder
    }
    pub fn label_widget<T: IsA<Widget>>(
        &mut self,
        value: &(impl Prop<T> + ?Sized),
    ) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("label_widget", val));
        value.connect_update(move |value| obj.set_property("label_widget", value));
        self.builder
    }
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn expanded(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("expanded", val));
        value.connect_update(move |value| obj.set_property("expanded", value));
        self.builder
    }
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_target", val));
        value.connect_update(move |value| obj.set_property("can_target", value));
        self.builder
    }
    pub fn height_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height_request", val));
        value.connect_update(move |value| obj.set_property("height_request", value));
        self.builder
    }
    pub fn use_underline(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ExpanderBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ExpanderSignals<'builder> {
    builder: &'builder mut ExpanderBuilder,
}
impl<'builder> ExpanderSignals<'builder> {}
impl ForteExt for Expander {
    type Builder = ExpanderBuilder;
}
#[macro_export]
macro_rules ! Expander { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: Expander :: forte ()) $ ($ rest) * } } }
