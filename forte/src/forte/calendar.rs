...
impl CalendarBuilder {
    ...
    pub fn show_heading(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_heading", value);
        self
    }
    ...
    pub fn show_day_names(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_day_names", value);
        self
    }
    ...
    pub fn day(&mut self, value: i32) -> &mut Self {
        self.obj.set_property("day", value);
        self
    }
    ...
    pub fn month(&mut self, value: i32) -> &mut Self {
        self.obj.set_property("month", value);
        self
    }
    ...
    pub fn year(&mut self, value: i32) -> &mut Self {
        self.obj.set_property("year", value);
        self
    }
    ...
    pub fn show_week_numbers(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_week_numbers", value);
        self
    }
    ...
    pub fn bind(&mut self) -> CalendarBinder {
        CalendarBinder { builder: self }
    }
    pub fn connect(&mut self) -> CalendarSignals {
        CalendarSignals { builder: self }
    }
}
impl crate::prelude::Builder for CalendarBuilder {
...
impl std::ops::Deref for CalendarBuilder {
    type Target = Calendar;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct CalendarBinder<'builder> {
    builder: &'builder mut CalendarBuilder,
}
impl<'builder> CalendarBinder<'builder> {
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn show_heading(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_heading", val));
        value.connect_update(move |value| obj.set_property("show_heading", value));
        self.builder
    }
    pub fn css_classes(
        &mut self,
    ...
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_markup", val));
        value.connect_update(move |value| obj.set_property("tooltip_markup", value));
        self.builder
    }
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand_set", val));
        value.connect_update(move |value| obj.set_property("vexpand_set", value));
        self.builder
    }
    pub fn show_day_names(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_day_names", val));
        value.connect_update(move |value| obj.set_property("show_day_names", value));
        self.builder
    }
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn height_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height_request", val));
        value.connect_update(move |value| obj.set_property("height_request", value));
        self.builder
    }
    pub fn day(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("day", val));
        value.connect_update(move |value| obj.set_property("day", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand", val));
        value.connect_update(move |value| obj.set_property("hexpand", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn month(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("month", val));
        value.connect_update(move |value| obj.set_property("month", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focusable", val));
        value.connect_update(move |value| obj.set_property("focusable", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("overflow", val));
        value.connect_update(move |value| obj.set_property("overflow", value));
        self.builder
    }
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_bottom", val));
        value.connect_update(move |value| obj.set_property("margin_bottom", value));
        self.builder
    }
    pub fn year(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("year", val));
        value.connect_update(move |value| obj.set_property("year", value));
        self.builder
    }
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focus_on_click", val));
        value.connect_update(move |value| obj.set_property("focus_on_click", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CalendarBuilder {
        let obj = self.builder.obj.clone();
...
pub struct CalendarSignals<'builder> {
    builder: &'builder mut CalendarBuilder,
}
impl<'builder> CalendarSignals<'builder> {}
impl ForteExt for Calendar {
    type Builder = CalendarBuilder;
}
#[macro_export]
macro_rules ! Calendar { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: Calendar :: forte ()) $ ($ rest) * } } }
