...
use gtkrs::{prelude::*, FontDialogButton, *};
use gtkrs::{
...
pub struct FontDialogButtonBuilder {
    obj: FontDialogButton,
}
impl Default for FontDialogButtonBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl FontDialogButtonBuilder {
    ...
    #[cfg(any(feature = "v4_10", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v4_10")))]
    pub fn dialog(&mut self, value: &FontDialog) -> &mut Self {
        self.obj.set_property("dialog", value);
        self
    }
    ...
    pub fn level(&mut self, value: FontLevel) -> &mut Self {
    ...
    pub fn bind(&mut self) -> FontDialogButtonBinder {
        FontDialogButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> FontDialogButtonSignals {
        FontDialogButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for FontDialogButtonBuilder {
    type Target = FontDialogButton;
...
impl std::ops::Deref for FontDialogButtonBuilder {
    type Target = FontDialogButton;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct FontDialogButtonBinder<'builder> {
    builder: &'builder mut FontDialogButtonBuilder,
}
impl<'builder> FontDialogButtonBinder<'builder> {
    pub fn tooltip_text(
        &mut self,
        value: &(impl Prop<str> + ?Sized),
    ) -> &mut FontDialogButtonBuilder {
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn use_size(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn use_font(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn dialog(
        &mut self,
        value: &(impl Prop<FontDialog> + ?Sized),
    ) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("dialog", val));
        value.connect_update(move |value| obj.set_property("dialog", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn level(
        &mut self,
        value: &(impl Prop<FontLevel> + ?Sized),
    ) -> &mut FontDialogButtonBuilder {
        let obj = self.builder.obj.clone();
...
pub struct FontDialogButtonSignals<'builder> {
    builder: &'builder mut FontDialogButtonBuilder,
}
impl<'builder> FontDialogButtonSignals<'builder> {}
impl ForteExt for FontDialogButton {
    type Builder = FontDialogButtonBuilder;
}
#[macro_export]
macro_rules ! FontDialogButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: FontDialogButton :: forte ()) $ ($ rest) * } } }
