...
impl ProgressBarBuilder {
    ...
    pub fn show_text(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_text", value);
        self
    }
    ...
    pub fn pulse_step(&mut self, value: f64) -> &mut Self {
        self.obj.set_property("pulse_step", value);
        self
    }
    ...
    pub fn fraction(&mut self, value: f64) -> &mut Self {
        self.obj.set_property("fraction", value);
        self
    }
    ...
    pub fn bind(&mut self) -> ProgressBarBinder {
        ProgressBarBinder { builder: self }
    }
    pub fn connect(&mut self) -> ProgressBarSignals {
        ProgressBarSignals { builder: self }
    }
}
impl crate::prelude::Builder for ProgressBarBuilder {
...
impl std::ops::Deref for ProgressBarBuilder {
    type Target = ProgressBar;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ProgressBarBinder<'builder> {
    builder: &'builder mut ProgressBarBuilder,
}
impl<'builder> ProgressBarBinder<'builder> {
    pub fn ellipsize(
        &mut self,
        value: &(impl Prop<pango::EllipsizeMode> + ?Sized),
    ) -> &mut ProgressBarBuilder {
    ...
    pub fn show_text(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_text", val));
        value.connect_update(move |value| obj.set_property("show_text", value));
        self.builder
    }
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cursor", val));
        value.connect_update(move |value| obj.set_property("cursor", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("overflow", val));
        value.connect_update(move |value| obj.set_property("overflow", value));
        self.builder
    }
    pub fn inverted(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn height_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height_request", val));
        value.connect_update(move |value| obj.set_property("height_request", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn pulse_step(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("pulse_step", val));
        value.connect_update(move |value| obj.set_property("pulse_step", value));
        self.builder
    }
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand_set", val));
        value.connect_update(move |value| obj.set_property("vexpand_set", value));
        self.builder
    }
    pub fn fraction(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("fraction", val));
        value.connect_update(move |value| obj.set_property("fraction", value));
        self.builder
    }
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand", val));
        value.connect_update(move |value| obj.set_property("vexpand", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ProgressBarBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ProgressBarSignals<'builder> {
    builder: &'builder mut ProgressBarBuilder,
}
impl<'builder> ProgressBarSignals<'builder> {}
impl ForteExt for ProgressBar {
    type Builder = ProgressBarBuilder;
}
#[macro_export]
macro_rules ! ProgressBar { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ProgressBar :: forte ()) $ ($ rest) * } } }
