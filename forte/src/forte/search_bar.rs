...
impl SearchBarBuilder {
    pub fn show_close_button(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_close_button", value);
        self
    }
    ...
    pub fn key_capture_widget(&mut self, value: &impl IsA<Widget>) -> &mut Self {
        self.obj.set_property("key_capture_widget", value);
        self
    }
    ...
    pub fn search_mode_enabled(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("search_mode_enabled", value);
        self
    }
    ...
    pub fn bind(&mut self) -> SearchBarBinder {
        SearchBarBinder { builder: self }
    }
    pub fn connect(&mut self) -> SearchBarSignals {
        SearchBarSignals { builder: self }
    }
}
impl crate::prelude::Builder for SearchBarBuilder {
...
impl std::ops::Deref for SearchBarBuilder {
    type Target = SearchBar;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct SearchBarBinder<'builder> {
    builder: &'builder mut SearchBarBuilder,
}
impl<'builder> SearchBarBinder<'builder> {
    pub fn show_close_button(
        &mut self,
        value: &(impl Prop<bool> + ?Sized),
    ) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_close_button", val));
        value.connect_update(move |value| obj.set_property("show_close_button", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn height_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height_request", val));
        value.connect_update(move |value| obj.set_property("height_request", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn search_mode_enabled(
        &mut self,
        value: &(impl Prop<bool> + ?Sized),
    ) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("search_mode_enabled", val));
        value.connect_update(move |value| obj.set_property("search_mode_enabled", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand", val));
        value.connect_update(move |value| obj.set_property("hexpand", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vexpand_set", val));
        value.connect_update(move |value| obj.set_property("vexpand_set", value));
        self.builder
    }
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut SearchBarBuilder {
        let obj = self.builder.obj.clone();
...
pub struct SearchBarSignals<'builder> {
    builder: &'builder mut SearchBarBuilder,
}
impl<'builder> SearchBarSignals<'builder> {}
impl ForteExt for SearchBar {
    type Builder = SearchBarBuilder;
}
#[macro_export]
macro_rules ! SearchBar { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: SearchBar :: forte ()) $ ($ rest) * } } }
