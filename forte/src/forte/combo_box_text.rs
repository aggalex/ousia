...
use gtkrs::{prelude::*, ComboBoxText, *};
use gtkrs::{
...
impl ComboBoxTextBuilder {
    ...
    pub fn bind(&mut self) -> ComboBoxTextBinder {
        ComboBoxTextBinder { builder: self }
    }
    pub fn connect(&mut self) -> ComboBoxTextSignals {
        ComboBoxTextSignals { builder: self }
    }
}
impl crate::prelude::Builder for ComboBoxTextBuilder {
    type Target = ComboBoxText;
...
impl std::ops::Deref for ComboBoxTextBuilder {
    type Target = ComboBoxText;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ComboBoxTextBinder<'builder> {
    builder: &'builder mut ComboBoxTextBuilder,
}
impl<'builder> ComboBoxTextBinder<'builder> {
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_target", val));
        value.connect_update(move |value| obj.set_property("can_target", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focusable", val));
        value.connect_update(move |value| obj.set_property("focusable", value));
        self.builder
    }
    pub fn active(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn has_frame(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_frame", val));
        value.connect_update(move |value| obj.set_property("has_frame", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn overflow(&mut self, value: &(impl Prop<Overflow> + ?Sized)) -> &mut ComboBoxTextBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ComboBoxTextSignals<'builder> {
    builder: &'builder mut ComboBoxTextBuilder,
}
impl<'builder> ComboBoxTextSignals<'builder> {}
impl ForteExt for ComboBoxText {
    type Builder = ComboBoxTextBuilder;
}
#[macro_export]
macro_rules ! ComboBoxText { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ComboBoxText :: forte ()) $ ($ rest) * } } }
