...
use gtkrs::{prelude::*, AppChooserButton, *};
use gtkrs::{
...
impl AppChooserButtonBuilder {
    pub fn show_dialog_item(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_dialog_item", value);
        self
    }
    ...
    pub fn show_default_item(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("show_default_item", value);
        self
    }
    ...
    pub fn heading(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("heading", value);
        self
    }
    ...
    pub fn bind(&mut self) -> AppChooserButtonBinder {
        AppChooserButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> AppChooserButtonSignals {
        AppChooserButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for AppChooserButtonBuilder {
    type Target = AppChooserButton;
...
impl std::ops::Deref for AppChooserButtonBuilder {
    type Target = AppChooserButton;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct AppChooserButtonBinder<'builder> {
    builder: &'builder mut AppChooserButtonBuilder,
}
impl<'builder> AppChooserButtonBinder<'builder> {
    pub fn show_dialog_item(
        &mut self,
        value: &(impl Prop<bool> + ?Sized),
    ) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_dialog_item", val));
        value.connect_update(move |value| obj.set_property("show_dialog_item", value));
        self.builder
    }
    pub fn has_tooltip(
        &mut self,
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn show_default_item(
        &mut self,
        value: &(impl Prop<bool> + ?Sized),
    ) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("show_default_item", val));
        value.connect_update(move |value| obj.set_property("show_default_item", value));
        self.builder
    }
    pub fn css_classes(
        &mut self,
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn modal(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn heading(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut AppChooserButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("heading", val));
        value.connect_update(move |value| obj.set_property("heading", value));
        self.builder
    }
...
pub struct AppChooserButtonSignals<'builder> {
    builder: &'builder mut AppChooserButtonBuilder,
}
impl<'builder> AppChooserButtonSignals<'builder> {}
impl ForteExt for AppChooserButton {
    type Builder = AppChooserButtonBuilder;
}
#[macro_export]
macro_rules ! AppChooserButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: AppChooserButton :: forte ()) $ ($ rest) * } } }
