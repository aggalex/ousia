...
use gtkrs::{prelude::*, ColorDialogButton, *};
use gtkrs::{
...
pub struct ColorDialogButtonBuilder {
    obj: ColorDialogButton,
}
impl Default for ColorDialogButtonBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl ColorDialogButtonBuilder {
    ...
    #[cfg(any(feature = "v4_10", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v4_10")))]
    pub fn dialog(&mut self, value: &ColorDialog) -> &mut Self {
    ...
    pub fn bind(&mut self) -> ColorDialogButtonBinder {
        ColorDialogButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> ColorDialogButtonSignals {
        ColorDialogButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for ColorDialogButtonBuilder {
    type Target = ColorDialogButton;
...
impl std::ops::Deref for ColorDialogButtonBuilder {
    type Target = ColorDialogButton;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ColorDialogButtonBinder<'builder> {
    builder: &'builder mut ColorDialogButtonBuilder,
}
impl<'builder> ColorDialogButtonBinder<'builder> {
    pub fn height_request(
        &mut self,
        value: &(impl Prop<i32> + ?Sized),
    ) -> &mut ColorDialogButtonBuilder {
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ColorDialogButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ColorDialogButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut ColorDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ColorDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn dialog(
        &mut self,
        value: &(impl Prop<ColorDialog> + ?Sized),
    ) -> &mut ColorDialogButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut ColorDialogButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ColorDialogButtonBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ColorDialogButtonSignals<'builder> {
    builder: &'builder mut ColorDialogButtonBuilder,
}
impl<'builder> ColorDialogButtonSignals<'builder> {}
impl ForteExt for ColorDialogButton {
    type Builder = ColorDialogButtonBuilder;
}
#[macro_export]
macro_rules ! ColorDialogButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ColorDialogButton :: forte ()) $ ($ rest) * } } }
