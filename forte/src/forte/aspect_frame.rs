...
impl AspectFrameBuilder {
    ...
    pub fn obey_child(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("obey_child", value);
        self
    }
    pub fn ratio(&mut self, value: f32) -> &mut Self {
        self.obj.set_property("ratio", value);
        self
    }
    ...
    pub fn bind(&mut self) -> AspectFrameBinder {
        AspectFrameBinder { builder: self }
    }
    pub fn connect(&mut self) -> AspectFrameSignals {
        AspectFrameSignals { builder: self }
    }
}
impl crate::prelude::Builder for AspectFrameBuilder {
    type Target = AspectFrame;
...
impl std::ops::Deref for AspectFrameBuilder {
    type Target = AspectFrame;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct AspectFrameBinder<'builder> {
    builder: &'builder mut AspectFrameBuilder,
}
impl<'builder> AspectFrameBinder<'builder> {
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AspectFrameBuilder {
    ...
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_top", val));
        value.connect_update(move |value| obj.set_property("margin_top", value));
        self.builder
    }
    pub fn obey_child(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("obey_child", val));
        value.connect_update(move |value| obj.set_property("obey_child", value));
        self.builder
    }
    pub fn ratio(&mut self, value: &(impl Prop<f32> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("ratio", val));
        value.connect_update(move |value| obj.set_property("ratio", value));
        self.builder
    }
    pub fn xalign(&mut self, value: &(impl Prop<f32> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("xalign", val));
        value.connect_update(move |value| obj.set_property("xalign", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn yalign(&mut self, value: &(impl Prop<f32> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("yalign", val));
        value.connect_update(move |value| obj.set_property("yalign", value));
        self.builder
    }
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut AspectFrameBuilder {
        let obj = self.builder.obj.clone();
...
pub struct AspectFrameSignals<'builder> {
    builder: &'builder mut AspectFrameBuilder,
}
impl<'builder> AspectFrameSignals<'builder> {}
impl ForteExt for AspectFrame {
    type Builder = AspectFrameBuilder;
}
#[macro_export]
macro_rules ! AspectFrame { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: AspectFrame :: forte ()) $ ($ rest) * } } }
