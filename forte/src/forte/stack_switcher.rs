...
use gtkrs::{prelude::*, StackSwitcher, *};
use gtkrs::{
...
impl StackSwitcherBuilder {
    ...
    pub fn bind(&mut self) -> StackSwitcherBinder {
        StackSwitcherBinder { builder: self }
    }
    pub fn connect(&mut self) -> StackSwitcherSignals {
        StackSwitcherSignals { builder: self }
    }
}
impl crate::prelude::Builder for StackSwitcherBuilder {
    type Target = StackSwitcher;
...
impl std::ops::Deref for StackSwitcherBuilder {
    type Target = StackSwitcher;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct StackSwitcherBinder<'builder> {
    builder: &'builder mut StackSwitcherBuilder,
}
impl<'builder> StackSwitcherBinder<'builder> {
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut StackSwitcherBuilder {
    ...
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn vexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn stack(&mut self, value: &(impl Prop<Stack> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("stack", val));
        value.connect_update(move |value| obj.set_property("stack", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackSwitcherBuilder {
        let obj = self.builder.obj.clone();
...
pub struct StackSwitcherSignals<'builder> {
    builder: &'builder mut StackSwitcherBuilder,
}
impl<'builder> StackSwitcherSignals<'builder> {}
impl ForteExt for StackSwitcher {
    type Builder = StackSwitcherBuilder;
}
#[macro_export]
macro_rules ! StackSwitcher { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: StackSwitcher :: forte ()) $ ($ rest) * } } }
