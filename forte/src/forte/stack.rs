...
impl StackBuilder {
    ...
    pub fn transition_duration(&mut self, value: u32) -> &mut Self {
        self.obj.set_property("transition_duration", value);
        self
    }
    ...
    pub fn hhomogeneous(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("hhomogeneous", value);
        self
    }
    ...
    pub fn vhomogeneous(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("vhomogeneous", value);
        self
    }
    pub fn visible_child(&mut self, value: &impl IsA<Widget>) -> &mut Self {
        self.obj.set_property("visible_child", value);
        self
    }
    ...
    pub fn transition_type(&mut self, value: StackTransitionType) -> &mut Self {
        self.obj.set_property("transition_type", value);
        self
    }
    ...
    pub fn visible_child_name(&mut self, value: &str) -> &mut Self {
        self.obj.set_property("visible_child_name", value);
        self
    }
    pub fn interpolate_size(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("interpolate_size", value);
        self
    }
    ...
    pub fn bind(&mut self) -> StackBinder {
        StackBinder { builder: self }
    }
    pub fn connect(&mut self) -> StackSignals {
        StackSignals { builder: self }
    }
}
impl crate::prelude::Builder for StackBuilder {
    type Target = Stack;
...
impl std::ops::Deref for StackBuilder {
    type Target = Stack;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct StackBinder<'builder> {
    builder: &'builder mut StackBuilder,
}
impl<'builder> StackBinder<'builder> {
    pub fn tooltip_markup(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut StackBuilder {
    ...
    pub fn hhomogeneous(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hhomogeneous", val));
        value.connect_update(move |value| obj.set_property("hhomogeneous", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn vhomogeneous(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("vhomogeneous", val));
        value.connect_update(move |value| obj.set_property("vhomogeneous", value));
        self.builder
    }
    pub fn visible_child<T: IsA<Widget>>(
        &mut self,
        value: &(impl Prop<T> + ?Sized),
    ) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible_child", val));
        value.connect_update(move |value| obj.set_property("visible_child", value));
        self.builder
    }
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn height_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height_request", val));
        value.connect_update(move |value| obj.set_property("height_request", value));
        self.builder
    }
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn css_classes(&mut self, value: &(impl Prop<Vec<String>> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_classes", val));
        value.connect_update(move |value| obj.set_property("css_classes", value));
        self.builder
    }
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_bottom", val));
        value.connect_update(move |value| obj.set_property("margin_bottom", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_end", val));
        value.connect_update(move |value| obj.set_property("margin_end", value));
        self.builder
    }
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn transition_type(
        &mut self,
        value: &(impl Prop<StackTransitionType> + ?Sized),
    ) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("transition_type", val));
        value.connect_update(move |value| obj.set_property("transition_type", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("name", val));
        value.connect_update(move |value| obj.set_property("name", value));
        self.builder
    }
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focus_on_click", val));
        value.connect_update(move |value| obj.set_property("focus_on_click", value));
        self.builder
    }
    pub fn visible_child_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible_child_name", val));
        value.connect_update(move |value| obj.set_property("visible_child_name", value));
        self.builder
    }
    pub fn interpolate_size(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("interpolate_size", val));
        value.connect_update(move |value| obj.set_property("interpolate_size", value));
        self.builder
    }
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cursor", val));
        value.connect_update(move |value| obj.set_property("cursor", value));
        self.builder
    }
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut StackBuilder {
        let obj = self.builder.obj.clone();
...
pub struct StackSignals<'builder> {
    builder: &'builder mut StackBuilder,
}
impl<'builder> StackSignals<'builder> {}
impl ForteExt for Stack {
    type Builder = StackBuilder;
}
#[macro_export]
macro_rules ! Stack { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: Stack :: forte ()) $ ($ rest) * } } }
