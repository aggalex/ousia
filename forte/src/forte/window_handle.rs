...
use gtkrs::{prelude::*, WindowHandle, *};
use gtkrs::{
...
impl WindowHandleBuilder {
    ...
    pub fn bind(&mut self) -> WindowHandleBinder {
        WindowHandleBinder { builder: self }
    }
    pub fn connect(&mut self) -> WindowHandleSignals {
        WindowHandleSignals { builder: self }
    }
}
impl crate::prelude::Builder for WindowHandleBuilder {
...
impl std::ops::Deref for WindowHandleBuilder {
    type Target = WindowHandle;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct WindowHandleBinder<'builder> {
    builder: &'builder mut WindowHandleBuilder,
}
impl<'builder> WindowHandleBinder<'builder> {
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut WindowHandleBuilder {
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_focus", val));
        value.connect_update(move |value| obj.set_property("can_focus", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focusable", val));
        value.connect_update(move |value| obj.set_property("focusable", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("css_name", val));
        value.connect_update(move |value| obj.set_property("css_name", value));
        self.builder
    }
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_target", val));
        value.connect_update(move |value| obj.set_property("can_target", value));
        self.builder
    }
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn tooltip_text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("tooltip_text", val));
        value.connect_update(move |value| obj.set_property("tooltip_text", value));
        self.builder
    }
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut WindowHandleBuilder {
        let obj = self.builder.obj.clone();
...
pub struct WindowHandleSignals<'builder> {
    builder: &'builder mut WindowHandleBuilder,
}
impl<'builder> WindowHandleSignals<'builder> {}
impl ForteExt for WindowHandle {
    type Builder = WindowHandleBuilder;
}
#[macro_export]
macro_rules ! WindowHandle { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: WindowHandle :: forte ()) $ ($ rest) * } } }
