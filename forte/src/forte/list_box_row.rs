...
impl ListBoxRowBuilder {
    ...
    pub fn selectable(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("selectable", value);
        self
    }
    ...
    pub fn bind(&mut self) -> ListBoxRowBinder {
        ListBoxRowBinder { builder: self }
    }
    pub fn connect(&mut self) -> ListBoxRowSignals {
        ListBoxRowSignals { builder: self }
    }
}
impl crate::prelude::Builder for ListBoxRowBuilder {
    type Target = ListBoxRow;
...
impl std::ops::Deref for ListBoxRowBuilder {
    type Target = ListBoxRow;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ListBoxRowBinder<'builder> {
    builder: &'builder mut ListBoxRowBuilder,
}
impl<'builder> ListBoxRowBinder<'builder> {
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxRowBuilder {
    ...
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn activatable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn has_tooltip(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("has_tooltip", val));
        value.connect_update(move |value| obj.set_property("has_tooltip", value));
        self.builder
    }
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("visible", val));
        value.connect_update(move |value| obj.set_property("visible", value));
        self.builder
    }
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ListBoxRowSignals<'builder> {
    builder: &'builder mut ListBoxRowBuilder,
}
impl<'builder> ListBoxRowSignals<'builder> {
    pub fn activatable_notify(
        &mut self,
        f: impl Fn(&ListBoxRow) + 'static,
    ) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_activatable_notify(f);
        &mut self.builder
    }
    pub fn child_notify(&mut self, f: impl Fn(&ListBoxRow) + 'static) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_child_notify(f);
        &mut self.builder
    }
    pub fn activate(&mut self, f: impl Fn(&ListBoxRow) + 'static) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_activate(f);
        &mut self.builder
    }
    pub fn selectable_notify(
        &mut self,
        f: impl Fn(&ListBoxRow) + 'static,
    ) -> &mut ListBoxRowBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_selectable_notify(f);
        &mut self.builder
    }
}
impl ForteExt for ListBoxRow {
    type Builder = ListBoxRowBuilder;
}
#[macro_export]
macro_rules ! ListBoxRow { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ListBoxRow :: forte ()) $ ($ rest) * } } }
