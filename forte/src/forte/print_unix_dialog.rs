...
use gtkrs::{prelude::*, PrintUnixDialog, *};
use gtkrs::{
...
impl Default for PrintUnixDialogBuilder {
    fn default() -> Self {
        Self {
            obj: glib::Object::new(&[]),
        }
...
impl PrintUnixDialogBuilder {
    ...
    pub fn page_setup(&mut self, value: &PageSetup) -> &mut Self {
        self.obj.set_property("page_setup", value);
        self
    }
    ...
    pub fn manual_capabilities(&mut self, value: PrintCapabilities) -> &mut Self {
        self.obj.set_property("manual_capabilities", value);
        self
    }
    ...
    pub fn bind(&mut self) -> PrintUnixDialogBinder {
        PrintUnixDialogBinder { builder: self }
    }
    pub fn connect(&mut self) -> PrintUnixDialogSignals {
        PrintUnixDialogSignals { builder: self }
    }
}
impl crate::prelude::Builder for PrintUnixDialogBuilder {
    type Target = PrintUnixDialog;
...
impl std::ops::Deref for PrintUnixDialogBuilder {
    type Target = PrintUnixDialog;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct PrintUnixDialogBinder<'builder> {
    builder: &'builder mut PrintUnixDialogBuilder,
}
impl<'builder> PrintUnixDialogBinder<'builder> {
    pub fn startup_id(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("startup_id", val));
        value.connect_update(move |value| obj.set_property("startup_id", value));
        self.builder
    }
    pub fn decorated(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("decorated", val));
        value.connect_update(move |value| obj.set_property("decorated", value));
        self.builder
    }
    pub fn can_focus(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn sensitive(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("sensitive", val));
        value.connect_update(move |value| obj.set_property("sensitive", value));
        self.builder
    }
    pub fn maximized(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn page_setup(
        ...
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("page_setup", val));
        value.connect_update(move |value| obj.set_property("page_setup", value));
        self.builder
    }
    ...
    pub fn vexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn icon_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("icon_name", val));
        value.connect_update(move |value| obj.set_property("icon_name", value));
        self.builder
    }
    pub fn deletable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn resizable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn title(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("title", val));
        value.connect_update(move |value| obj.set_property("title", value));
        self.builder
    }
    pub fn modal(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("modal", val));
        value.connect_update(move |value| obj.set_property("modal", value));
        self.builder
    }
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn manual_capabilities(
        &mut self,
        value: &(impl Prop<PrintCapabilities> + ?Sized),
    ) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("manual_capabilities", val));
        value.connect_update(move |value| obj.set_property("manual_capabilities", value));
        self.builder
    }
    pub fn can_target(
        &mut self,
    ...
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn hexpand(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("valign", val));
        value.connect_update(move |value| obj.set_property("valign", value));
        self.builder
    }
    pub fn margin_top(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_top", val));
        value.connect_update(move |value| obj.set_property("margin_top", value));
        self.builder
    }
    pub fn css_name(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut PrintUnixDialogBuilder {
        let obj = self.builder.obj.clone();
...
pub struct PrintUnixDialogSignals<'builder> {
    builder: &'builder mut PrintUnixDialogBuilder,
}
impl<'builder> PrintUnixDialogSignals<'builder> {}
impl ForteExt for PrintUnixDialog {
    type Builder = PrintUnixDialogBuilder;
}
#[macro_export]
macro_rules ! PrintUnixDialog { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: PrintUnixDialog :: forte ()) $ ($ rest) * } } }
