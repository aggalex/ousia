...
use gtkrs::{prelude::*, CellRendererSpin, *};
use gtkrs::{Adjustment, CellRenderer, CellRendererMode, CellRendererText};
#[derive(Clone)]
pub struct CellRendererSpinBuilder {
    obj: CellRendererSpin,
}
...
impl CellRendererSpinBuilder {
    ...
    pub fn bind(&mut self) -> CellRendererSpinBinder {
        CellRendererSpinBinder { builder: self }
    }
    pub fn connect(&mut self) -> CellRendererSpinSignals {
        CellRendererSpinSignals { builder: self }
    }
}
impl crate::prelude::Builder for CellRendererSpinBuilder {
    type Target = CellRendererSpin;
...
impl std::ops::Deref for CellRendererSpinBuilder {
    type Target = CellRendererSpin;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct CellRendererSpinBinder<'builder> {
    builder: &'builder mut CellRendererSpinBuilder,
}
impl<'builder> CellRendererSpinBinder<'builder> {
    pub fn text(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererSpinBuilder {
    ...
    pub fn language(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn family(&mut self, value: &(impl Prop<str> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn size_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn size(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("size", val));
        value.connect_update(move |value| obj.set_property("size", value));
        self.builder
    }
    pub fn scale(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn digits(&mut self, value: &(impl Prop<u32> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn xalign(&mut self, value: &(impl Prop<f32> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn rise_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn editable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn ypad(&mut self, value: &(impl Prop<u32> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("ypad", val));
        value.connect_update(move |value| obj.set_property("ypad", value));
        self.builder
    }
    pub fn height(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("height", val));
        value.connect_update(move |value| obj.set_property("height", value));
        self.builder
    }
    pub fn yalign(&mut self, value: &(impl Prop<f32> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn visible(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn width(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn rise(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut CellRendererSpinBuilder {
        let obj = self.builder.obj.clone();
...
pub struct CellRendererSpinSignals<'builder> {
    builder: &'builder mut CellRendererSpinBuilder,
}
impl<'builder> CellRendererSpinSignals<'builder> {}
impl ForteExt for CellRendererSpin {
    type Builder = CellRendererSpinBuilder;
}
#[macro_export]
macro_rules ! CellRendererSpin { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: CellRendererSpin :: forte ()) $ ($ rest) * } } }
