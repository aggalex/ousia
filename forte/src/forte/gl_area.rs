...
impl GLAreaBuilder {
    ...
    pub fn use_es(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("use_es", value);
        self
    }
    pub fn has_stencil_buffer(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("has_stencil_buffer", value);
        self
    }
    ...
    pub fn has_depth_buffer(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("has_depth_buffer", value);
        self
    }
    ...
    pub fn auto_render(&mut self, value: bool) -> &mut Self {
        self.obj.set_property("auto_render", value);
        self
    }
    ...
    pub fn bind(&mut self) -> GLAreaBinder {
        GLAreaBinder { builder: self }
    }
    pub fn connect(&mut self) -> GLAreaSignals {
        GLAreaSignals { builder: self }
    }
}
impl crate::prelude::Builder for GLAreaBuilder {
    type Target = GLArea;
...
impl std::ops::Deref for GLAreaBuilder {
    type Target = GLArea;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct GLAreaBinder<'builder> {
    builder: &'builder mut GLAreaBuilder,
}
impl<'builder> GLAreaBinder<'builder> {
    pub fn focus_on_click(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut GLAreaBuilder {
    ...
    pub fn focusable(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("focusable", val));
        value.connect_update(move |value| obj.set_property("focusable", value));
        self.builder
    }
    pub fn receives_default(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn can_target(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("can_target", val));
        value.connect_update(move |value| obj.set_property("can_target", value));
        self.builder
    }
    pub fn auto_render(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("auto_render", val));
        value.connect_update(move |value| obj.set_property("auto_render", value));
        self.builder
    }
    pub fn margin_bottom(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_bottom", val));
        value.connect_update(move |value| obj.set_property("margin_bottom", value));
        self.builder
    }
    pub fn opacity(&mut self, value: &(impl Prop<f64> + ?Sized)) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("opacity", val));
        value.connect_update(move |value| obj.set_property("opacity", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("cursor", val));
        value.connect_update(move |value| obj.set_property("cursor", value));
        self.builder
    }
    pub fn valign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
...
pub struct GLAreaSignals<'builder> {
    builder: &'builder mut GLAreaBuilder,
}
impl<'builder> GLAreaSignals<'builder> {
    pub fn has_depth_buffer_notify(&mut self, f: impl Fn(&GLArea) + 'static) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_has_depth_buffer_notify(f);
        &mut self.builder
    }
    pub fn render(&mut self, f: impl Fn(&GLArea, &gdk::GLContext) + 'static) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_render(f);
        &mut self.builder
    }
    pub fn has_stencil_buffer_notify(
        &mut self,
        f: impl Fn(&GLArea) + 'static,
    ) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_has_stencil_buffer_notify(f);
        &mut self.builder
    }
    pub fn context_notify(&mut self, f: impl Fn(&GLArea) + 'static) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_context_notify(f);
        &mut self.builder
    }
    pub fn resize(&mut self, f: impl Fn(&GLArea, i32, i32) + 'static) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_resize(f);
        &mut self.builder
    }
    pub fn create_context(&mut self, f: impl Fn(&GLArea) + 'static) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_create_context(f);
        &mut self.builder
    }
    pub fn use_es_notify(&mut self, f: impl Fn(&GLArea) + 'static) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_use_es_notify(f);
        &mut self.builder
    }
    pub fn auto_render_notify(&mut self, f: impl Fn(&GLArea) + 'static) -> &mut GLAreaBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_auto_render_notify(f);
        &mut self.builder
    }
}
impl ForteExt for GLArea {
    type Builder = GLAreaBuilder;
}
#[macro_export]
macro_rules ! GLArea { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: GLArea :: forte ()) $ ($ rest) * } } }
