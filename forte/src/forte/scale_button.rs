...
impl ScaleButtonBuilder {
    ...
    pub fn icons(&mut self, value: Vec<String>) -> &mut Self {
        self.obj.set_property("icons", value);
        self
    }
    ...
    pub fn bind(&mut self) -> ScaleButtonBinder {
        ScaleButtonBinder { builder: self }
    }
    pub fn connect(&mut self) -> ScaleButtonSignals {
        ScaleButtonSignals { builder: self }
    }
}
impl crate::prelude::Builder for ScaleButtonBuilder {
    type Target = ScaleButton;
...
impl std::ops::Deref for ScaleButtonBuilder {
    type Target = ScaleButton;
    fn deref(&self) -> &Self::Target {
        &self.obj
    }
}
pub struct ScaleButtonBinder<'builder> {
    builder: &'builder mut ScaleButtonBuilder,
}
impl<'builder> ScaleButtonBinder<'builder> {
    pub fn accessible_role(
        &mut self,
        value: &(impl Prop<AccessibleRole> + ?Sized),
    ) -> &mut ScaleButtonBuilder {
    ...
    pub fn halign(&mut self, value: &(impl Prop<Align> + ?Sized)) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("halign", val));
        value.connect_update(move |value| obj.set_property("halign", value));
        self.builder
    }
    pub fn margin_start(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("margin_start", val));
        value.connect_update(move |value| obj.set_property("margin_start", value));
        self.builder
    }
    pub fn icons(&mut self, value: &(impl Prop<Vec<String>> + ?Sized)) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("icons", val));
        value.connect_update(move |value| obj.set_property("icons", value));
        self.builder
    }
    pub fn hexpand_set(&mut self, value: &(impl Prop<bool> + ?Sized)) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("hexpand_set", val));
        value.connect_update(move |value| obj.set_property("hexpand_set", value));
        self.builder
    }
    pub fn cursor(&mut self, value: &(impl Prop<gdk::Cursor> + ?Sized)) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
    ...
    pub fn width_request(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        value.with(|val| obj.set_property("width_request", val));
        value.connect_update(move |value| obj.set_property("width_request", value));
        self.builder
    }
    pub fn margin_end(&mut self, value: &(impl Prop<i32> + ?Sized)) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
...
pub struct ScaleButtonSignals<'builder> {
    builder: &'builder mut ScaleButtonBuilder,
}
impl<'builder> ScaleButtonSignals<'builder> {
    pub fn popup(&mut self, f: impl Fn(&ScaleButton) + 'static) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_popup(f);
        &mut self.builder
    }
    pub fn value_changed(
        &mut self,
        f: impl Fn(&ScaleButton, f64) + 'static,
    ) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_value_changed(f);
        &mut self.builder
    }
    pub fn adjustment_notify(
        &mut self,
        f: impl Fn(&ScaleButton) + 'static,
    ) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_adjustment_notify(f);
        &mut self.builder
    }
    pub fn popdown(&mut self, f: impl Fn(&ScaleButton) + 'static) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_popdown(f);
        &mut self.builder
    }
    pub fn icons_notify(&mut self, f: impl Fn(&ScaleButton) + 'static) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_icons_notify(f);
        &mut self.builder
    }
    pub fn value_notify(&mut self, f: impl Fn(&ScaleButton) + 'static) -> &mut ScaleButtonBuilder {
        let obj = self.builder.obj.clone();
        obj.connect_value_notify(f);
        &mut self.builder
    }
}
impl ForteExt for ScaleButton {
    type Builder = ScaleButtonBuilder;
}
#[macro_export]
macro_rules ! ScaleButton { { $ ($ rest : tt) * } => { forte ! { (gtkrs :: ScaleButton :: forte ()) $ ($ rest) * } } }
